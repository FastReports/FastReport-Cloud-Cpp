...
FilePermissionsVM::FilePermissionsVM()
{
...
void FilePermissionsVM::validate()
{
    // TODO: implement validation
}

web::json::value FilePermissionsVM::toJson() const
{
...
bool FilePermissionsVM::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("permissions"))))
    {
        ...
        {
            std::shared_ptr<FilePermissionsCRUDVM> refVal_setPermissions;
...
void FilePermissionsVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FilePermissionsVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<FilePermissionsCRUDVM> FilePermissionsVM::getPermissions() const
{
    return m_permissions;
}

void FilePermissionsVM::setPermissions(const std::shared_ptr<FilePermissionsCRUDVM>& value)
{
    m_permissions = value;
    m_permissionsIsSet = true;
}

bool FilePermissionsVM::permissionsIsSet() const
{
    return m_permissionsIsSet;
}

void FilePermissionsVM::unsetpermissions()
{
    m_permissionsIsSet = false;
}
}
