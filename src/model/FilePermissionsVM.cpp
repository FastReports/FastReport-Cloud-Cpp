...
bool FilePermissionsVM::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("permissions"))))
    {
        ...
        {
            std::shared_ptr<FilePermissions> refVal_setPermissions;
...
std::shared_ptr<FilePermissions> FilePermissionsVM::getPermissions() const
{
    return m_permissions;
}

void FilePermissionsVM::setPermissions(const std::shared_ptr<FilePermissions>& value)
{
    m_permissions = value;
