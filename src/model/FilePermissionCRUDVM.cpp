...
FilePermissionCRUDVM::FilePermissionCRUDVM()
{
    m_createIsSet = false;
...
void FilePermissionCRUDVM::validate()
{
    // TODO: implement validation
}

web::json::value FilePermissionCRUDVM::toJson() const
{
...
bool FilePermissionCRUDVM::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void FilePermissionCRUDVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FilePermissionCRUDVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<FileCreate> FilePermissionCRUDVM::getCreate() const
{
    return m_create;
}

void FilePermissionCRUDVM::setCreate(const std::shared_ptr<FileCreate>& value)
{
    m_create = value;
    m_createIsSet = true;
}

bool FilePermissionCRUDVM::createIsSet() const
{
    return m_createIsSet;
}

void FilePermissionCRUDVM::unsetcreate()
{
    m_createIsSet = false;
}
std::shared_ptr<FileDelete> FilePermissionCRUDVM::getRDelete() const
{
    return m_r_delete;
}

void FilePermissionCRUDVM::setRDelete(const std::shared_ptr<FileDelete>& value)
{
    m_r_delete = value;
    m_r_deleteIsSet = true;
}

bool FilePermissionCRUDVM::rDeleteIsSet() const
{
    return m_r_deleteIsSet;
}

void FilePermissionCRUDVM::unsetr_delete()
{
    m_r_deleteIsSet = false;
}
std::shared_ptr<FileExecute> FilePermissionCRUDVM::getExecute() const
{
    return m_execute;
}

void FilePermissionCRUDVM::setExecute(const std::shared_ptr<FileExecute>& value)
{
    m_execute = value;
    m_executeIsSet = true;
}

bool FilePermissionCRUDVM::executeIsSet() const
{
    return m_executeIsSet;
}

void FilePermissionCRUDVM::unsetexecute()
{
    m_executeIsSet = false;
}
std::shared_ptr<FileGet> FilePermissionCRUDVM::getGet() const
{
    return m_get;
}

void FilePermissionCRUDVM::setGet(const std::shared_ptr<FileGet>& value)
{
    m_get = value;
    m_getIsSet = true;
}

bool FilePermissionCRUDVM::getIsSet() const
{
    return m_getIsSet;
}

void FilePermissionCRUDVM::unsetget()
{
    m_getIsSet = false;
}
std::shared_ptr<FileUpdate> FilePermissionCRUDVM::getUpdate() const
{
    return m_update;
}

void FilePermissionCRUDVM::setUpdate(const std::shared_ptr<FileUpdate>& value)
{
    m_update = value;
    m_updateIsSet = true;
}

bool FilePermissionCRUDVM::updateIsSet() const
{
    return m_updateIsSet;
}

void FilePermissionCRUDVM::unsetupdate()
{
    m_updateIsSet = false;
}
std::shared_ptr<FileAdministrate> FilePermissionCRUDVM::getAdministrate() const
{
    return m_administrate;
}

void FilePermissionCRUDVM::setAdministrate(const std::shared_ptr<FileAdministrate>& value)
{
    m_administrate = value;
    m_administrateIsSet = true;
}

bool FilePermissionCRUDVM::administrateIsSet() const
{
    return m_administrateIsSet;
}

void FilePermissionCRUDVM::unsetadministrate()
{
    m_administrateIsSet = false;
}
}
