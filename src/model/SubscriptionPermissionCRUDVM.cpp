...
SubscriptionPermissionCRUDVM::SubscriptionPermissionCRUDVM()
{
    m_createIsSet = false;
...
void SubscriptionPermissionCRUDVM::validate()
{
    // TODO: implement validation
}

web::json::value SubscriptionPermissionCRUDVM::toJson() const
{
...
bool SubscriptionPermissionCRUDVM::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("create"))))
    {
        ...
        {
            std::shared_ptr<SubscriptionCreate> refVal_setCreate;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("delete"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SubscriptionDelete> refVal_setRDelete;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("execute"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SubscriptionExecute> refVal_setExecute;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("get"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SubscriptionGet> refVal_setGet;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("update"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SubscriptionUpdate> refVal_setUpdate;
...
void SubscriptionPermissionCRUDVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SubscriptionPermissionCRUDVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<SubscriptionCreate> SubscriptionPermissionCRUDVM::getCreate() const
{
    return m_create;
}

void SubscriptionPermissionCRUDVM::setCreate(const std::shared_ptr<SubscriptionCreate>& value)
{
    m_create = value;
    m_createIsSet = true;
}

bool SubscriptionPermissionCRUDVM::createIsSet() const
{
    return m_createIsSet;
}

void SubscriptionPermissionCRUDVM::unsetcreate()
{
    m_createIsSet = false;
}
std::shared_ptr<SubscriptionDelete> SubscriptionPermissionCRUDVM::getRDelete() const
{
    return m_r_delete;
}

void SubscriptionPermissionCRUDVM::setRDelete(const std::shared_ptr<SubscriptionDelete>& value)
{
    m_r_delete = value;
    m_r_deleteIsSet = true;
}

bool SubscriptionPermissionCRUDVM::rDeleteIsSet() const
{
    return m_r_deleteIsSet;
}

void SubscriptionPermissionCRUDVM::unsetr_delete()
{
    m_r_deleteIsSet = false;
}
std::shared_ptr<SubscriptionExecute> SubscriptionPermissionCRUDVM::getExecute() const
{
    return m_execute;
}

void SubscriptionPermissionCRUDVM::setExecute(const std::shared_ptr<SubscriptionExecute>& value)
{
    m_execute = value;
    m_executeIsSet = true;
}

bool SubscriptionPermissionCRUDVM::executeIsSet() const
{
    return m_executeIsSet;
}

void SubscriptionPermissionCRUDVM::unsetexecute()
{
    m_executeIsSet = false;
}
std::shared_ptr<SubscriptionGet> SubscriptionPermissionCRUDVM::getGet() const
{
    return m_get;
}

void SubscriptionPermissionCRUDVM::setGet(const std::shared_ptr<SubscriptionGet>& value)
{
    m_get = value;
    m_getIsSet = true;
}

bool SubscriptionPermissionCRUDVM::getIsSet() const
{
    return m_getIsSet;
}

void SubscriptionPermissionCRUDVM::unsetget()
{
    m_getIsSet = false;
}
std::shared_ptr<SubscriptionUpdate> SubscriptionPermissionCRUDVM::getUpdate() const
{
    return m_update;
}

void SubscriptionPermissionCRUDVM::setUpdate(const std::shared_ptr<SubscriptionUpdate>& value)
{
    m_update = value;
    m_updateIsSet = true;
}

bool SubscriptionPermissionCRUDVM::updateIsSet() const
{
    return m_updateIsSet;
}

void SubscriptionPermissionCRUDVM::unsetupdate()
{
    m_updateIsSet = false;
}
std::shared_ptr<SubscriptionAdministrate> SubscriptionPermissionCRUDVM::getAdministrate() const
{
    return m_administrate;
}

void SubscriptionPermissionCRUDVM::setAdministrate(const std::shared_ptr<SubscriptionAdministrate>& value)
{
    m_administrate = value;
    m_administrateIsSet = true;
}

bool SubscriptionPermissionCRUDVM::administrateIsSet() const
{
    return m_administrateIsSet;
}

void SubscriptionPermissionCRUDVM::unsetadministrate()
{
    m_administrateIsSet = false;
}
}
