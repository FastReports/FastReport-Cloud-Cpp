...
bool SubscriptionPermissionsVM::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("permissions"))))
    {
        ...
        {
            std::shared_ptr<SubscriptionPermissionsCRUDVM> refVal_setPermissions;
...
std::shared_ptr<SubscriptionPermissionsCRUDVM> SubscriptionPermissionsVM::getPermissions() const
{
    return m_permissions;
}

void SubscriptionPermissionsVM::setPermissions(const std::shared_ptr<SubscriptionPermissionsCRUDVM>& value)
{
    m_permissions = value;
