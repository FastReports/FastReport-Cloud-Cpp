...
bool UpdateTaskPermissionsVM::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("newPermissions"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TaskPermissionsCRUDVM> refVal_setNewPermissions;
...
std::shared_ptr<TaskPermissionsCRUDVM> UpdateTaskPermissionsVM::getNewPermissions() const
{
    return m_newPermissions;
}

void UpdateTaskPermissionsVM::setNewPermissions(const std::shared_ptr<TaskPermissionsCRUDVM>& value)
{
