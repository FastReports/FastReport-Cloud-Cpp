...
CreateTaskEndVM::CreateTaskEndVM()
{
    m_after = 0;
    m_afterIsSet = false;
...
void CreateTaskEndVM::validate()
{
    // TODO: implement validation
}

web::json::value CreateTaskEndVM::toJson() const
{
...
bool CreateTaskEndVM::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateTaskEndVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateTaskEndVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t CreateTaskEndVM::getAfter() const
{
    return m_after;
}

void CreateTaskEndVM::setAfter(int32_t value)
{
    m_after = value;
    m_afterIsSet = true;
}

bool CreateTaskEndVM::afterIsSet() const
{
    return m_afterIsSet;
}

void CreateTaskEndVM::unsetafter()
{
    m_afterIsSet = false;
}
utility::datetime CreateTaskEndVM::getOn() const
{
    return m_on;
}

void CreateTaskEndVM::setOn(const utility::datetime& value)
{
    m_on = value;
    m_onIsSet = true;
}

bool CreateTaskEndVM::onIsSet() const
{
    return m_onIsSet;
}

void CreateTaskEndVM::unseton()
{
    m_onIsSet = false;
}
}
