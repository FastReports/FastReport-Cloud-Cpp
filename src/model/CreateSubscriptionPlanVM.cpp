...
#include "CppRestOpenAPIClient/model/CreateSubscriptionPlanVM.h"
...
std::shared_ptr<TimePeriodType> CreateSubscriptionPlanVM::getTimePeriodType() const
{
    return m_timePeriodType;
}

void CreateSubscriptionPlanVM::setTimePeriodType(const std::shared_ptr<TimePeriodType>& value)
{
...
std::shared_ptr<TimePeriodType> CreateSubscriptionPlanVM::getReadonlyTimeLimitType() const
{
    return m_readonlyTimeLimitType;
}

void CreateSubscriptionPlanVM::setReadonlyTimeLimitType(const std::shared_ptr<TimePeriodType>& value)
{
...
std::shared_ptr<TaskSettingsVM> CreateSubscriptionPlanVM::getTasks() const
{
    return m_tasks;
}

void CreateSubscriptionPlanVM::setTasks(const std::shared_ptr<TaskSettingsVM>& value)
{
    m_tasks = value;
    m_tasksIsSet = true;
}

bool CreateSubscriptionPlanVM::tasksIsSet() const
{
    return m_tasksIsSet;
}

void CreateSubscriptionPlanVM::unsettasks()
{
    m_tasksIsSet = false;
}
}
