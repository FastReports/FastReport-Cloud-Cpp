...
bool DefaultPermissionsVM::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("filePermissions"))))
    {
        ...
        {
            std::shared_ptr<FilePermissions> refVal_setFilePermissions;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("dataSourcePermissions"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<DataSourcePermissions> refVal_setDataSourcePermissions;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("taskPermissions"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TaskPermissions> refVal_setTaskPermissions;
...
std::shared_ptr<TaskPermissions> DefaultPermissionsVM::getTaskPermissions() const
{
    return m_taskPermissions;
}

void DefaultPermissionsVM::setTaskPermissions(const std::shared_ptr<TaskPermissions>& value)
{
