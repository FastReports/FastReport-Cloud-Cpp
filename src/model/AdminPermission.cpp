...
void AdminPermission::validate()
{
    // TODO: implement validation
}

web::json::value AdminPermission::toJson() const
{
...
bool AdminPermission::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AdminPermission::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdminPermission::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<AdminCreate> AdminPermission::getCreate() const
{
    return m_create;
}

void AdminPermission::setCreate(const std::shared_ptr<AdminCreate>& value)
{
    m_create = value;
    m_createIsSet = true;
}

bool AdminPermission::createIsSet() const
{
    return m_createIsSet;
}

void AdminPermission::unsetcreate()
{
    m_createIsSet = false;
}
std::shared_ptr<AdminDelete> AdminPermission::getRDelete() const
{
    return m_r_delete;
}

void AdminPermission::setRDelete(const std::shared_ptr<AdminDelete>& value)
{
    m_r_delete = value;
    m_r_deleteIsSet = true;
}

bool AdminPermission::rDeleteIsSet() const
{
    return m_r_deleteIsSet;
}

void AdminPermission::unsetr_delete()
{
    m_r_deleteIsSet = false;
}
std::shared_ptr<AdminExecute> AdminPermission::getExecute() const
{
    return m_execute;
}

void AdminPermission::setExecute(const std::shared_ptr<AdminExecute>& value)
{
    m_execute = value;
    m_executeIsSet = true;
}

bool AdminPermission::executeIsSet() const
{
    return m_executeIsSet;
}

void AdminPermission::unsetexecute()
{
    m_executeIsSet = false;
}
std::shared_ptr<AdminGet> AdminPermission::getGet() const
{
    return m_get;
}

void AdminPermission::setGet(const std::shared_ptr<AdminGet>& value)
{
    m_get = value;
    m_getIsSet = true;
}

bool AdminPermission::getIsSet() const
{
    return m_getIsSet;
}

void AdminPermission::unsetget()
{
    m_getIsSet = false;
}
std::shared_ptr<AdminUpdate> AdminPermission::getUpdate() const
{
    return m_update;
}

void AdminPermission::setUpdate(const std::shared_ptr<AdminUpdate>& value)
{
    m_update = value;
    m_updateIsSet = true;
}

bool AdminPermission::updateIsSet() const
{
    return m_updateIsSet;
}

void AdminPermission::unsetupdate()
{
    m_updateIsSet = false;
}
std::shared_ptr<AdminAdministrate> AdminPermission::getAdministrate() const
{
    return m_administrate;
}

void AdminPermission::setAdministrate(const std::shared_ptr<AdminAdministrate>& value)
{
    m_administrate = value;
    m_administrateIsSet = true;
}

bool AdminPermission::administrateIsSet() const
{
    return m_administrateIsSet;
}

void AdminPermission::unsetadministrate()
{
    m_administrateIsSet = false;
}
}
