...
SubscriptionPermissionsCRUDVM::SubscriptionPermissionsCRUDVM()
{
...
void SubscriptionPermissionsCRUDVM::validate()
{
    // TODO: implement validation
}

web::json::value SubscriptionPermissionsCRUDVM::toJson() const
{
...
bool SubscriptionPermissionsCRUDVM::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("owner"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SubscriptionPermissionCRUDVM> refVal_setOwner;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("groups"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::map<utility::string_t, std::shared_ptr<SubscriptionPermissionCRUDVM>> refVal_setGroups;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("other"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SubscriptionPermissionCRUDVM> refVal_setOther;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("anon"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SubscriptionPermissionCRUDVM> refVal_setAnon;
...
void SubscriptionPermissionsCRUDVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SubscriptionPermissionsCRUDVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t SubscriptionPermissionsCRUDVM::getOwnerId() const
{
    return m_ownerId;
}

void SubscriptionPermissionsCRUDVM::setOwnerId(const utility::string_t& value)
{
    m_ownerId = value;
    m_ownerIdIsSet = true;
}

bool SubscriptionPermissionsCRUDVM::ownerIdIsSet() const
{
    return m_ownerIdIsSet;
}

void SubscriptionPermissionsCRUDVM::unsetownerId()
{
    m_ownerIdIsSet = false;
}
std::shared_ptr<SubscriptionPermissionCRUDVM> SubscriptionPermissionsCRUDVM::getOwner() const
{
    return m_owner;
}

void SubscriptionPermissionsCRUDVM::setOwner(const std::shared_ptr<SubscriptionPermissionCRUDVM>& value)
{
    m_owner = value;
    m_ownerIsSet = true;
}

bool SubscriptionPermissionsCRUDVM::ownerIsSet() const
{
    return m_ownerIsSet;
}

void SubscriptionPermissionsCRUDVM::unsetowner()
{
    m_ownerIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<SubscriptionPermissionCRUDVM>>& SubscriptionPermissionsCRUDVM::getGroups()
{
    return m_groups;
}

void SubscriptionPermissionsCRUDVM::setGroups(const std::map<utility::string_t, std::shared_ptr<SubscriptionPermissionCRUDVM>>& value)
{
    m_groups = value;
    m_groupsIsSet = true;
}

bool SubscriptionPermissionsCRUDVM::groupsIsSet() const
{
    return m_groupsIsSet;
}

void SubscriptionPermissionsCRUDVM::unsetgroups()
{
    m_groupsIsSet = false;
}
std::shared_ptr<SubscriptionPermissionCRUDVM> SubscriptionPermissionsCRUDVM::getOther() const
{
    return m_other;
}

void SubscriptionPermissionsCRUDVM::setOther(const std::shared_ptr<SubscriptionPermissionCRUDVM>& value)
{
    m_other = value;
    m_otherIsSet = true;
}

bool SubscriptionPermissionsCRUDVM::otherIsSet() const
{
    return m_otherIsSet;
}

void SubscriptionPermissionsCRUDVM::unsetother()
{
    m_otherIsSet = false;
}
std::shared_ptr<SubscriptionPermissionCRUDVM> SubscriptionPermissionsCRUDVM::getAnon() const
{
    return m_anon;
}

void SubscriptionPermissionsCRUDVM::setAnon(const std::shared_ptr<SubscriptionPermissionCRUDVM>& value)
{
    m_anon = value;
    m_anonIsSet = true;
}

bool SubscriptionPermissionsCRUDVM::anonIsSet() const
{
    return m_anonIsSet;
}

void SubscriptionPermissionsCRUDVM::unsetanon()
{
    m_anonIsSet = false;
}
}
