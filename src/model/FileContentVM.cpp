...
#include "CppRestOpenAPIClient/model/FileContentVM.h"
...
void FileContentVM::validate()
{
    // TODO: implement validation
}

web::json::value FileContentVM::toJson() const
{
...
bool FileContentVM::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void FileContentVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FileContentVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t FileContentVM::getContent() const
{
    return m_content;
}

void FileContentVM::setContent(const utility::string_t& value)
{
    m_content = value;
    m_contentIsSet = true;
}

bool FileContentVM::contentIsSet() const
{
    return m_contentIsSet;
}

void FileContentVM::unsetcontent()
{
    m_contentIsSet = false;
}
}
