...
#include "CppRestOpenAPIClient/model/RunFTPUploadTaskVM.h"
...
void RunFTPUploadTaskVM::validate()
{
    // TODO: implement validation
}

web::json::value RunFTPUploadTaskVM::toJson() const
{
...
bool RunFTPUploadTaskVM::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RunFTPUploadTaskVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RunFTPUploadTaskVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool RunFTPUploadTaskVM::isArchive() const
{
    return m_archive;
}

void RunFTPUploadTaskVM::setArchive(bool value)
{
    m_archive = value;
    m_archiveIsSet = true;
}

bool RunFTPUploadTaskVM::archiveIsSet() const
{
    return m_archiveIsSet;
}

void RunFTPUploadTaskVM::unsetarchive()
{
    m_archiveIsSet = false;
}
utility::string_t RunFTPUploadTaskVM::getArchiveName() const
{
    return m_archiveName;
}

void RunFTPUploadTaskVM::setArchiveName(const utility::string_t& value)
{
    m_archiveName = value;
    m_archiveNameIsSet = true;
}

bool RunFTPUploadTaskVM::archiveNameIsSet() const
{
    return m_archiveNameIsSet;
}

void RunFTPUploadTaskVM::unsetarchiveName()
{
    m_archiveNameIsSet = false;
}
utility::string_t RunFTPUploadTaskVM::getDestinationFolder() const
{
    return m_destinationFolder;
}

void RunFTPUploadTaskVM::setDestinationFolder(const utility::string_t& value)
{
    m_destinationFolder = value;
    m_destinationFolderIsSet = true;
}

bool RunFTPUploadTaskVM::destinationFolderIsSet() const
{
    return m_destinationFolderIsSet;
}

void RunFTPUploadTaskVM::unsetdestinationFolder()
{
    m_destinationFolderIsSet = false;
}
utility::string_t RunFTPUploadTaskVM::getFtpHost() const
{
    return m_ftpHost;
}

void RunFTPUploadTaskVM::setFtpHost(const utility::string_t& value)
{
    m_ftpHost = value;
    m_ftpHostIsSet = true;
}

bool RunFTPUploadTaskVM::ftpHostIsSet() const
{
    return m_ftpHostIsSet;
}

void RunFTPUploadTaskVM::unsetftpHost()
{
    m_ftpHostIsSet = false;
}
utility::string_t RunFTPUploadTaskVM::getFtpPassword() const
{
    return m_ftpPassword;
}

void RunFTPUploadTaskVM::setFtpPassword(const utility::string_t& value)
{
    m_ftpPassword = value;
    m_ftpPasswordIsSet = true;
}

bool RunFTPUploadTaskVM::ftpPasswordIsSet() const
{
    return m_ftpPasswordIsSet;
}

void RunFTPUploadTaskVM::unsetftpPassword()
{
    m_ftpPasswordIsSet = false;
}
int32_t RunFTPUploadTaskVM::getFtpPort() const
{
    return m_ftpPort;
}

void RunFTPUploadTaskVM::setFtpPort(int32_t value)
{
    m_ftpPort = value;
    m_ftpPortIsSet = true;
}

bool RunFTPUploadTaskVM::ftpPortIsSet() const
{
    return m_ftpPortIsSet;
}

void RunFTPUploadTaskVM::unsetftpPort()
{
    m_ftpPortIsSet = false;
}
utility::string_t RunFTPUploadTaskVM::getFtpUsername() const
{
    return m_ftpUsername;
}

void RunFTPUploadTaskVM::setFtpUsername(const utility::string_t& value)
{
    m_ftpUsername = value;
    m_ftpUsernameIsSet = true;
}

bool RunFTPUploadTaskVM::ftpUsernameIsSet() const
{
    return m_ftpUsernameIsSet;
}

void RunFTPUploadTaskVM::unsetftpUsername()
{
    m_ftpUsernameIsSet = false;
}
bool RunFTPUploadTaskVM::isUseSFTP() const
{
    return m_useSFTP;
}

void RunFTPUploadTaskVM::setUseSFTP(bool value)
{
    m_useSFTP = value;
    m_useSFTPIsSet = true;
}

bool RunFTPUploadTaskVM::useSFTPIsSet() const
{
    return m_useSFTPIsSet;
}

void RunFTPUploadTaskVM::unsetuseSFTP()
{
    m_useSFTPIsSet = false;
}
}
