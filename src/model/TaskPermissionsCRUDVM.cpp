...
TaskPermissionsCRUDVM::TaskPermissionsCRUDVM()
{
...
void TaskPermissionsCRUDVM::validate()
{
    // TODO: implement validation
}

web::json::value TaskPermissionsCRUDVM::toJson() const
{
...
bool TaskPermissionsCRUDVM::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("owner"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TaskPermissionCRUDVM> refVal_setOwner;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("groups"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::map<utility::string_t, std::shared_ptr<TaskPermissionCRUDVM>> refVal_setGroups;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("other"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TaskPermissionCRUDVM> refVal_setOther;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("anon"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TaskPermissionCRUDVM> refVal_setAnon;
...
void TaskPermissionsCRUDVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TaskPermissionsCRUDVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t TaskPermissionsCRUDVM::getOwnerId() const
{
    return m_ownerId;
}

void TaskPermissionsCRUDVM::setOwnerId(const utility::string_t& value)
{
    m_ownerId = value;
    m_ownerIdIsSet = true;
}

bool TaskPermissionsCRUDVM::ownerIdIsSet() const
{
    return m_ownerIdIsSet;
}

void TaskPermissionsCRUDVM::unsetownerId()
{
    m_ownerIdIsSet = false;
}
std::shared_ptr<TaskPermissionCRUDVM> TaskPermissionsCRUDVM::getOwner() const
{
    return m_owner;
}

void TaskPermissionsCRUDVM::setOwner(const std::shared_ptr<TaskPermissionCRUDVM>& value)
{
    m_owner = value;
    m_ownerIsSet = true;
}

bool TaskPermissionsCRUDVM::ownerIsSet() const
{
    return m_ownerIsSet;
}

void TaskPermissionsCRUDVM::unsetowner()
{
    m_ownerIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<TaskPermissionCRUDVM>>& TaskPermissionsCRUDVM::getGroups()
{
    return m_groups;
}

void TaskPermissionsCRUDVM::setGroups(const std::map<utility::string_t, std::shared_ptr<TaskPermissionCRUDVM>>& value)
{
    m_groups = value;
    m_groupsIsSet = true;
}

bool TaskPermissionsCRUDVM::groupsIsSet() const
{
    return m_groupsIsSet;
}

void TaskPermissionsCRUDVM::unsetgroups()
{
    m_groupsIsSet = false;
}
std::shared_ptr<TaskPermissionCRUDVM> TaskPermissionsCRUDVM::getOther() const
{
    return m_other;
}

void TaskPermissionsCRUDVM::setOther(const std::shared_ptr<TaskPermissionCRUDVM>& value)
{
    m_other = value;
    m_otherIsSet = true;
}

bool TaskPermissionsCRUDVM::otherIsSet() const
{
    return m_otherIsSet;
}

void TaskPermissionsCRUDVM::unsetother()
{
    m_otherIsSet = false;
}
std::shared_ptr<TaskPermissionCRUDVM> TaskPermissionsCRUDVM::getAnon() const
{
    return m_anon;
}

void TaskPermissionsCRUDVM::setAnon(const std::shared_ptr<TaskPermissionCRUDVM>& value)
{
    m_anon = value;
    m_anonIsSet = true;
}

bool TaskPermissionsCRUDVM::anonIsSet() const
{
    return m_anonIsSet;
}

void TaskPermissionsCRUDVM::unsetanon()
{
    m_anonIsSet = false;
}
}
