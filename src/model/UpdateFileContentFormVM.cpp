...
#include "CppRestOpenAPIClient/model/UpdateFileContentFormVM.h"
...
UpdateFileContentFormVM::UpdateFileContentFormVM()
{
...
void UpdateFileContentFormVM::validate()
{
    // TODO: implement validation
}

web::json::value UpdateFileContentFormVM::toJson() const
{
...
bool UpdateFileContentFormVM::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateFileContentFormVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateFileContentFormVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<HttpContent> UpdateFileContentFormVM::getFileContent() const
{
    return m_fileContent;
}

void UpdateFileContentFormVM::setFileContent(const std::shared_ptr<HttpContent>& value)
{
    m_fileContent = value;
    m_fileContentIsSet = true;
}

bool UpdateFileContentFormVM::fileContentIsSet() const
{
    return m_fileContentIsSet;
}

void UpdateFileContentFormVM::unsetfileContent()
{
    m_fileContentIsSet = false;
}
}
