...
web::json::value ServerConfigurationVM::toJson() const
{
    ...
    if(m_sharingEnabledIsSet)
    {
        val[utility::conversions::to_string_t(U("sharingEnabled"))] = ModelBase::toJson(m_sharingEnabled);
    }
...
bool ServerConfigurationVM::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("frontend"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<FrontendAppVM> refVal_setFrontend;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("sharingEnabled"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("sharingEnabled")));
        if(!fieldValue.is_null())
        {
            bool refVal_setSharingEnabled;
            ok &= ModelBase::fromJson(fieldValue, refVal_setSharingEnabled);
            setSharingEnabled(refVal_setSharingEnabled);
        }
    }
    return ok;
}
...
void ServerConfigurationVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_sharingEnabledIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("sharingEnabled")), m_sharingEnabled));
    }
    if(m_tIsSet)
    {
...
bool ServerConfigurationVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("sharingEnabled"))))
    {
        bool refVal_setSharingEnabled;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("sharingEnabled"))), refVal_setSharingEnabled );
        setSharingEnabled(refVal_setSharingEnabled);
    }
...
std::shared_ptr<FrontendAppVM> ServerConfigurationVM::getFrontend() const
{
    return m_frontend;
}

void ServerConfigurationVM::setFrontend(const std::shared_ptr<FrontendAppVM>& value)
{
    m_frontend = value;
...
bool ServerConfigurationVM::isSharingEnabled() const
{
    return m_sharingEnabled;
}

void ServerConfigurationVM::setSharingEnabled(bool value)
{
    m_sharingEnabled = value;
    m_sharingEnabledIsSet = true;
}

bool ServerConfigurationVM::sharingEnabledIsSet() const
{
    return m_sharingEnabledIsSet;
}

void ServerConfigurationVM::unsetsharingEnabled()
{
    m_sharingEnabledIsSet = false;
}
}
