...
#include "CppRestOpenAPIClient/model/FilesVMBase.h"
...
void FilesVMBase::validate()
{
    // TODO: implement validation
}

web::json::value FilesVMBase::toJson() const
{
...
bool FilesVMBase::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void FilesVMBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FilesVMBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<FileVM>>& FilesVMBase::getFiles()
{
    return m_files;
}

void FilesVMBase::setFiles(const std::vector<std::shared_ptr<FileVM>>& value)
{
    m_files = value;
    m_filesIsSet = true;
}

bool FilesVMBase::filesIsSet() const
{
    return m_filesIsSet;
}

void FilesVMBase::unsetfiles()
{
    m_filesIsSet = false;
}
int64_t FilesVMBase::getCount() const
{
    return m_count;
}

void FilesVMBase::setCount(int64_t value)
{
    m_count = value;
    m_countIsSet = true;
}

bool FilesVMBase::countIsSet() const
{
    return m_countIsSet;
}

void FilesVMBase::unsetcount()
{
    m_countIsSet = false;
}
int32_t FilesVMBase::getSkip() const
{
    return m_skip;
}

void FilesVMBase::setSkip(int32_t value)
{
    m_skip = value;
    m_skipIsSet = true;
}

bool FilesVMBase::skipIsSet() const
{
    return m_skipIsSet;
}

void FilesVMBase::unsetskip()
{
    m_skipIsSet = false;
}
int32_t FilesVMBase::getTake() const
{
    return m_take;
}

void FilesVMBase::setTake(int32_t value)
{
    m_take = value;
    m_takeIsSet = true;
}

bool FilesVMBase::takeIsSet() const
{
    return m_takeIsSet;
}

void FilesVMBase::unsettake()
{
    m_takeIsSet = false;
}
}
