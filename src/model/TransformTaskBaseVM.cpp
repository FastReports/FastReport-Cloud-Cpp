...
std::vector<utility::string_t>& TransformTaskBaseVM::getTransportIds()
{
    return m_transportIds;
}

void TransformTaskBaseVM::setTransportIds(const std::vector<utility::string_t>& value)
{
    m_transportIds = value;
    m_transportIdsIsSet = true;
}

bool TransformTaskBaseVM::transportIdsIsSet() const
{
    return m_transportIdsIsSet;
}

void TransformTaskBaseVM::unsettransportIds()
{
    m_transportIdsIsSet = false;
}
}
