...
void CreateContactVM::validate()
{
    // TODO: implement validation
}

web::json::value CreateContactVM::toJson() const
{
...
bool CreateContactVM::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateContactVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateContactVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CreateContactVM::getName() const
{
    return m_name;
}

void CreateContactVM::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool CreateContactVM::nameIsSet() const
{
    return m_nameIsSet;
}

void CreateContactVM::unsetname()
{
    m_nameIsSet = false;
}
utility::string_t CreateContactVM::getEmail() const
{
    return m_email;
}

void CreateContactVM::setEmail(const utility::string_t& value)
{
    m_email = value;
    m_emailIsSet = true;
}

bool CreateContactVM::emailIsSet() const
{
    return m_emailIsSet;
}

void CreateContactVM::unsetemail()
{
    m_emailIsSet = false;
}
std::vector<utility::string_t>& CreateContactVM::getGroups()
{
    return m_groups;
}

void CreateContactVM::setGroups(const std::vector<utility::string_t>& value)
{
    m_groups = value;
    m_groupsIsSet = true;
}

bool CreateContactVM::groupsIsSet() const
{
    return m_groupsIsSet;
}

void CreateContactVM::unsetgroups()
{
    m_groupsIsSet = false;
}
utility::string_t CreateContactVM::getSubscriptionId() const
{
    return m_subscriptionId;
}

void CreateContactVM::setSubscriptionId(const utility::string_t& value)
{
    m_subscriptionId = value;
    m_subscriptionIdIsSet = true;
}

bool CreateContactVM::subscriptionIdIsSet() const
{
    return m_subscriptionIdIsSet;
}

void CreateContactVM::unsetsubscriptionId()
{
    m_subscriptionIdIsSet = false;
}
}
