...
GroupPermissionsCRUDVM::GroupPermissionsCRUDVM()
{
...
void GroupPermissionsCRUDVM::validate()
{
    // TODO: implement validation
}

web::json::value GroupPermissionsCRUDVM::toJson() const
{
...
bool GroupPermissionsCRUDVM::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("owner"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<GroupPermissionCRUDVM> refVal_setOwner;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("groups"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::map<utility::string_t, std::shared_ptr<GroupPermissionCRUDVM>> refVal_setGroups;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("other"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<GroupPermissionCRUDVM> refVal_setOther;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("anon"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<GroupPermissionCRUDVM> refVal_setAnon;
...
void GroupPermissionsCRUDVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GroupPermissionsCRUDVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t GroupPermissionsCRUDVM::getOwnerId() const
{
    return m_ownerId;
}

void GroupPermissionsCRUDVM::setOwnerId(const utility::string_t& value)
{
    m_ownerId = value;
    m_ownerIdIsSet = true;
}

bool GroupPermissionsCRUDVM::ownerIdIsSet() const
{
    return m_ownerIdIsSet;
}

void GroupPermissionsCRUDVM::unsetownerId()
{
    m_ownerIdIsSet = false;
}
std::shared_ptr<GroupPermissionCRUDVM> GroupPermissionsCRUDVM::getOwner() const
{
    return m_owner;
}

void GroupPermissionsCRUDVM::setOwner(const std::shared_ptr<GroupPermissionCRUDVM>& value)
{
    m_owner = value;
    m_ownerIsSet = true;
}

bool GroupPermissionsCRUDVM::ownerIsSet() const
{
    return m_ownerIsSet;
}

void GroupPermissionsCRUDVM::unsetowner()
{
    m_ownerIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<GroupPermissionCRUDVM>>& GroupPermissionsCRUDVM::getGroups()
{
    return m_groups;
}

void GroupPermissionsCRUDVM::setGroups(const std::map<utility::string_t, std::shared_ptr<GroupPermissionCRUDVM>>& value)
{
    m_groups = value;
    m_groupsIsSet = true;
}

bool GroupPermissionsCRUDVM::groupsIsSet() const
{
    return m_groupsIsSet;
}

void GroupPermissionsCRUDVM::unsetgroups()
{
    m_groupsIsSet = false;
}
std::shared_ptr<GroupPermissionCRUDVM> GroupPermissionsCRUDVM::getOther() const
{
    return m_other;
}

void GroupPermissionsCRUDVM::setOther(const std::shared_ptr<GroupPermissionCRUDVM>& value)
{
    m_other = value;
    m_otherIsSet = true;
}

bool GroupPermissionsCRUDVM::otherIsSet() const
{
    return m_otherIsSet;
}

void GroupPermissionsCRUDVM::unsetother()
{
    m_otherIsSet = false;
}
std::shared_ptr<GroupPermissionCRUDVM> GroupPermissionsCRUDVM::getAnon() const
{
    return m_anon;
}

void GroupPermissionsCRUDVM::setAnon(const std::shared_ptr<GroupPermissionCRUDVM>& value)
{
    m_anon = value;
    m_anonIsSet = true;
}

bool GroupPermissionsCRUDVM::anonIsSet() const
{
    return m_anonIsSet;
}

void GroupPermissionsCRUDVM::unsetanon()
{
    m_anonIsSet = false;
}
}
