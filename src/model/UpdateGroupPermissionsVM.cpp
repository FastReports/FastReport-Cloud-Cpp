...
bool UpdateGroupPermissionsVM::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("newPermissions"))))
    {
        ...
        {
            std::shared_ptr<GroupPermissionsCRUDVM> refVal_setNewPermissions;
...
std::shared_ptr<GroupPermissionsCRUDVM> UpdateGroupPermissionsVM::getNewPermissions() const
{
    return m_newPermissions;
}

void UpdateGroupPermissionsVM::setNewPermissions(const std::shared_ptr<GroupPermissionsCRUDVM>& value)
{
