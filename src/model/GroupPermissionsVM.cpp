...
GroupPermissionsVM::GroupPermissionsVM()
{
...
void GroupPermissionsVM::validate()
{
    // TODO: implement validation
}

web::json::value GroupPermissionsVM::toJson() const
{
...
bool GroupPermissionsVM::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("permissions"))))
    {
        ...
        {
            std::shared_ptr<GroupPermissionsCRUDVM> refVal_setPermissions;
...
void GroupPermissionsVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GroupPermissionsVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<GroupPermissionsCRUDVM> GroupPermissionsVM::getPermissions() const
{
    return m_permissions;
}

void GroupPermissionsVM::setPermissions(const std::shared_ptr<GroupPermissionsCRUDVM>& value)
{
    m_permissions = value;
    m_permissionsIsSet = true;
}

bool GroupPermissionsVM::permissionsIsSet() const
{
    return m_permissionsIsSet;
}

void GroupPermissionsVM::unsetpermissions()
{
    m_permissionsIsSet = false;
}
}
