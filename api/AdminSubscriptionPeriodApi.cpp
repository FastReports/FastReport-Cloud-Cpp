...
#include "AdminSubscriptionPeriodApi.h"
#include "IHttpBody.h"
#include "JsonBody.h"
...
AdminSubscriptionPeriodApi::AdminSubscriptionPeriodApi( std::shared_ptr<const ApiClient> apiClient )
    : m_ApiClient(apiClient)
{
}

AdminSubscriptionPeriodApi::~AdminSubscriptionPeriodApi()
{
}

pplx::task<std::shared_ptr<SubscriptionVM>> AdminSubscriptionPeriodApi::adminSubscriptionPeriodRenewSubscription(utility::string_t id, boost::optional<std::shared_ptr<CreateSubscriptionPeriodVM>> viewModel) const
{


    std::shared_ptr<const ApiConfiguration> localVarApiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t localVarPath = utility::conversions::to_string_t("/api/admin/v1/Subscriptions/{id}/Renew");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("AdminSubscriptionPeriodApi->adminSubscriptionPeriodRenewSubscription does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("AdminSubscriptionPeriodApi->adminSubscriptionPeriodRenewSubscription does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response localVarResponse)
    {
        ...
        if (localVarResponse.status_code() >= 400)
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling adminSubscriptionPeriodRenewSubscription: ") + localVarResponse.reason_phrase()
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( localVarContentType.find(localVarResponseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling adminSubscriptionPeriodRenewSubscription: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling adminSubscriptionPeriodRenewSubscription: unsupported response type"));
        }
