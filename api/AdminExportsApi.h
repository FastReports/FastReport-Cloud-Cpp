...
#ifndef FASTREPORT_CLOUD_CLIENT_AdminExportsApi_H_
#define FASTREPORT_CLOUD_CLIENT_AdminExportsApi_H_

#include "CloudKludge.h"
#include "../ApiClient.h"

#include "AdminExportFolderCreateVM.h"
...
class  AdminExportsApi 
{
public:

    explicit AdminExportsApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~AdminExportsApi();
    ...
    pplx::task<void> adminExportFoldersDeleteFolder(
        utility::string_t id,
    ...
    pplx::task<std::shared_ptr<FileVM>> adminExportFoldersGetFolder(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<FilesVM>> adminExportFoldersGetFolders(
    ...
    /// </remarks>
    /// <param name="id">folder id</param>
    pplx::task<std::shared_ptr<FilePermissionsVM>> adminExportFoldersGetPermissions(
        utility::string_t id
    ) const;
    /// <summary>
    /// Create a folder
    ...
    pplx::task<std::shared_ptr<FileVM>> adminExportFoldersPostFolder(
        boost::optional<std::shared_ptr<AdminExportFolderCreateVM>> folderVm
    ) const;
    /// <summary>
    /// Update a folder
    /// </summary>
    ...
    pplx::task<std::shared_ptr<FileVM>> adminExportFoldersUpdateFolder(
        utility::string_t id,
    ...
    pplx::task<void> adminExportFoldersUpdatePermissions(
        utility::string_t id,
    ...
    pplx::task<void> adminExportsDeleteFile(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ExportVM>> adminExportsGetFile(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ExportsVM>> adminExportsGetFiles(
        boost::optional<int32_t> skip,
        boost::optional<int32_t> take,
        boost::optional<utility::string_t> subscriptionId
    ) const;
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<std::shared_ptr<FilePermissionsVM>> adminExportsGetPermissions(
        utility::string_t id
    ) const;
    /// <summary>
    /// Update a file
    ...
    pplx::task<std::shared_ptr<ExportVM>> adminExportsUpdateFile(
        utility::string_t id,
    ...
    /// <param name="id"></param>
    /// <param name="newPermissions"> (optional)</param>
    pplx::task<void> adminExportsUpdatePermissions(
        utility::string_t id,
        boost::optional<std::shared_ptr<UpdateFilePermissionsVM>> newPermissions
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="fileVM">file&#39;s view model (optional)</param>
    pplx::task<std::shared_ptr<ExportVM>> adminExportsUploadFile(
        boost::optional<std::shared_ptr<ExportCreateAdminVM>> fileVM
    ) const;
...
#endif /* FASTREPORT_CLOUD_CLIENT_AdminExportsApi_H_ */
