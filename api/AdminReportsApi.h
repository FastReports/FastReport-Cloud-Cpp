...
#ifndef FASTREPORT_CLOUD_CLIENT_AdminReportsApi_H_
#define FASTREPORT_CLOUD_CLIENT_AdminReportsApi_H_
...
public:
    ...
    explicit AdminReportsApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~AdminReportsApi();
    ...
    pplx::task<void> adminReportFoldersDeleteFolder(
        utility::string_t id,
    ...
    pplx::task<std::shared_ptr<FileVM>> adminReportFoldersGetFolder(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<FilesVM>> adminReportFoldersGetFolders(
    ...
    /// </remarks>
    /// <param name="id">folder id</param>
    pplx::task<std::shared_ptr<FilePermissionsVM>> adminReportFoldersGetPermissions(
        utility::string_t id
    ) const;
    /// <summary>
    /// Create a folder
    ...
    pplx::task<std::shared_ptr<FileVM>> adminReportFoldersPostFolder(
        boost::optional<std::shared_ptr<AdminReportFolderCreateVM>> folderVm
    ) const;
    /// <summary>
    /// Update a folder
    /// </summary>
    ...
    pplx::task<std::shared_ptr<FileVM>> adminReportFoldersUpdateFolder(
        utility::string_t id,
    ...
    pplx::task<void> adminReportFoldersUpdatePermissions(
        utility::string_t id,
    ...
    pplx::task<void> adminReportsDeleteFile(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ReportVM>> adminReportsGetFile(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ReportsVM>> adminReportsGetFiles(
        boost::optional<int32_t> skip,
        boost::optional<int32_t> take,
        boost::optional<utility::string_t> subscriptionId
    ) const;
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<std::shared_ptr<FilePermissionsVM>> adminReportsGetPermissions(
        utility::string_t id
    ) const;
    /// <summary>
    /// Update a file
    ...
    pplx::task<std::shared_ptr<ReportVM>> adminReportsUpdateFile(
        utility::string_t id,
    ...
    /// <param name="id"></param>
    /// <param name="newPermissions"> (optional)</param>
    pplx::task<void> adminReportsUpdatePermissions(
        utility::string_t id,
        boost::optional<std::shared_ptr<UpdateFilePermissionsVM>> newPermissions
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="fileVM">file&#39;s view model (optional)</param>
    pplx::task<std::shared_ptr<ReportVM>> adminReportsUploadFile(
        boost::optional<std::shared_ptr<ReportCreateAdminVM>> fileVM
    ) const;
...
#endif /* FASTREPORT_CLOUD_CLIENT_AdminReportsApi_H_ */
