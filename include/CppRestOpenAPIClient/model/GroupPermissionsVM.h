...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<GroupPermissionsCRUDVM> getPermissions() const;
    bool permissionsIsSet() const;
    void unsetpermissions();

    void setPermissions(const std::shared_ptr<GroupPermissionsCRUDVM>& value);


protected:
    std::shared_ptr<GroupPermissionsCRUDVM> m_permissions;
