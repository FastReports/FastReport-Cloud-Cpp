...
#ifndef FASTREPORT_CLOUD_MODELS_CreateContactVM_H_
#define FASTREPORT_CLOUD_MODELS_CreateContactVM_H_
...
/// 
/// </summary>
class  CreateContactVM
    : public ModelBase
{
public:
    CreateContactVM();
    virtual ~CreateContactVM();
...
#endif /* FASTREPORT_CLOUD_MODELS_CreateContactVM_H_ */
