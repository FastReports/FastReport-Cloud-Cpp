...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<FrontendAppVM> getFrontend() const;
    bool frontendIsSet() const;
    void unsetfrontend();

    void setFrontend(const std::shared_ptr<FrontendAppVM>& value);
    ...
    bool sharingEnabledIsSet() const;
...
protected:
    ...
    std::shared_ptr<FrontendAppVM> m_frontend;
