...
public:
    ...
    pplx::task<void> templateFolderAndFileCopyFiles(
        utility::string_t subscriptionId,
    ...
    pplx::task<std::shared_ptr<CountVM>> templateFolderAndFileCountRecycleBinFoldersAndFiles(
        utility::string_t subscriptionId,
    ...
    /// <param name="subscriptionId">id of current subscription</param>
    /// <param name="selectedFilesVM">VM with files&#39; ids and params of their destination (optional)</param>
    pplx::task<void> templateFolderAndFileMoveFiles(
        utility::string_t subscriptionId,
        boost::optional<std::shared_ptr<SelectedFilesVM>> selectedFilesVM
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<FileSharingKeysVM>> templatesCreateSharingKey(
        utility::string_t id,
    ...
    pplx::task<void> templatesDeleteSharingKey(
        utility::string_t id,
    ...
    /// </remarks>
    /// <param name="id">file id</param>
    pplx::task<std::shared_ptr<FileSharingKeysVM>> templatesGetSharingKeys(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<void> templatesUpdateContentV2(
        utility::string_t id,
    ...
    pplx::task<std::shared_ptr<TemplateVM>> templatesUploadFileV2(
        utility::string_t id,
        std::shared_ptr<HttpContent> fileContent,
