...
utility::string_t TemplateFolderCreateVM::getName() const
{
    return m_name;
}

void TemplateFolderCreateVM::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool TemplateFolderCreateVM::nameIsSet() const
{
    return m_nameIsSet;
}

void TemplateFolderCreateVM::unsetname()
{
    m_nameIsSet = false;
}
std::vector<utility::string_t>& TemplateFolderCreateVM::getTags()
{
    return m_tags;
}

void TemplateFolderCreateVM::setTags(const std::vector<utility::string_t>& value)
{
    m_tags = value;
    m_tagsIsSet = true;
}

bool TemplateFolderCreateVM::tagsIsSet() const
{
    return m_tagsIsSet;
}

void TemplateFolderCreateVM::unsettags()
{
    m_tagsIsSet = false;
}
utility::string_t TemplateFolderCreateVM::getIcon() const
{
    return m_icon;
}

void TemplateFolderCreateVM::setIcon(const utility::string_t& value)
{
    m_icon = value;
    m_iconIsSet = true;
}

bool TemplateFolderCreateVM::iconIsSet() const
{
    return m_iconIsSet;
}

void TemplateFolderCreateVM::unseticon()
{
    m_iconIsSet = false;
}
}
