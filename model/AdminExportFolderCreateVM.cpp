...
utility::string_t AdminExportFolderCreateVM::getParentId() const
{
    return m_parentId;
}

void AdminExportFolderCreateVM::setParentId(const utility::string_t& value)
{
    m_parentId = value;
    m_parentIdIsSet = true;
}

bool AdminExportFolderCreateVM::parentIdIsSet() const
{
    return m_parentIdIsSet;
}

void AdminExportFolderCreateVM::unsetparentId()
{
    m_parentIdIsSet = false;
}
utility::string_t AdminExportFolderCreateVM::getOwnerId() const
{
    return m_ownerId;
}

void AdminExportFolderCreateVM::setOwnerId(const utility::string_t& value)
{
    m_ownerId = value;
    m_ownerIdIsSet = true;
}

bool AdminExportFolderCreateVM::ownerIdIsSet() const
{
    return m_ownerIdIsSet;
}

void AdminExportFolderCreateVM::unsetownerId()
{
    m_ownerIdIsSet = false;
}
utility::string_t AdminExportFolderCreateVM::getName() const
{
    return m_name;
}

void AdminExportFolderCreateVM::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool AdminExportFolderCreateVM::nameIsSet() const
{
    return m_nameIsSet;
}

void AdminExportFolderCreateVM::unsetname()
{
    m_nameIsSet = false;
}
std::vector<utility::string_t>& AdminExportFolderCreateVM::getTags()
{
    return m_tags;
}

void AdminExportFolderCreateVM::setTags(const std::vector<utility::string_t>& value)
{
    m_tags = value;
    m_tagsIsSet = true;
}

bool AdminExportFolderCreateVM::tagsIsSet() const
{
    return m_tagsIsSet;
}

void AdminExportFolderCreateVM::unsettags()
{
    m_tagsIsSet = false;
}
utility::string_t AdminExportFolderCreateVM::getIcon() const
{
    return m_icon;
}

void AdminExportFolderCreateVM::setIcon(const utility::string_t& value)
{
    m_icon = value;
    m_iconIsSet = true;
}

bool AdminExportFolderCreateVM::iconIsSet() const
{
    return m_iconIsSet;
}

void AdminExportFolderCreateVM::unseticon()
{
    m_iconIsSet = false;
}
}
