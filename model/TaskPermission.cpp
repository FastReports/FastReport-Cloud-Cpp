...
void TaskPermission::validate()
{
    // TODO: implement validation
}

web::json::value TaskPermission::toJson() const
{
...
bool TaskPermission::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TaskPermission::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TaskPermission::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<TaskCreate> TaskPermission::getCreate() const
{
    return m_create;
}

void TaskPermission::setCreate(const std::shared_ptr<TaskCreate>& value)
{
    m_create = value;
    m_createIsSet = true;
}

bool TaskPermission::createIsSet() const
{
    return m_createIsSet;
}

void TaskPermission::unsetcreate()
{
    m_createIsSet = false;
}
std::shared_ptr<TaskDelete> TaskPermission::getRDelete() const
{
    return m_r_delete;
}

void TaskPermission::setRDelete(const std::shared_ptr<TaskDelete>& value)
{
    m_r_delete = value;
    m_r_deleteIsSet = true;
}

bool TaskPermission::rDeleteIsSet() const
{
    return m_r_deleteIsSet;
}

void TaskPermission::unsetr_delete()
{
    m_r_deleteIsSet = false;
}
std::shared_ptr<TaskExecute> TaskPermission::getExecute() const
{
    return m_execute;
}

void TaskPermission::setExecute(const std::shared_ptr<TaskExecute>& value)
{
    m_execute = value;
    m_executeIsSet = true;
}

bool TaskPermission::executeIsSet() const
{
    return m_executeIsSet;
}

void TaskPermission::unsetexecute()
{
    m_executeIsSet = false;
}
std::shared_ptr<TaskGet> TaskPermission::getGet() const
{
    return m_get;
}

void TaskPermission::setGet(const std::shared_ptr<TaskGet>& value)
{
    m_get = value;
    m_getIsSet = true;
}

bool TaskPermission::getIsSet() const
{
    return m_getIsSet;
}

void TaskPermission::unsetget()
{
    m_getIsSet = false;
}
std::shared_ptr<TaskUpdate> TaskPermission::getUpdate() const
{
    return m_update;
}

void TaskPermission::setUpdate(const std::shared_ptr<TaskUpdate>& value)
{
    m_update = value;
    m_updateIsSet = true;
}

bool TaskPermission::updateIsSet() const
{
    return m_updateIsSet;
}

void TaskPermission::unsetupdate()
{
    m_updateIsSet = false;
}
std::shared_ptr<TaskAdministrate> TaskPermission::getAdministrate() const
{
    return m_administrate;
}

void TaskPermission::setAdministrate(const std::shared_ptr<TaskAdministrate>& value)
{
    m_administrate = value;
    m_administrateIsSet = true;
}

bool TaskPermission::administrateIsSet() const
{
    return m_administrateIsSet;
}

void TaskPermission::unsetadministrate()
{
    m_administrateIsSet = false;
}
}
