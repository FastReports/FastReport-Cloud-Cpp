...
bool UpdateWebhookTaskVM::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("endpoints")))
    {
        ...
        {
            std::vector<std::shared_ptr<UpdateEndpointVM>> refVal_endpoints;
...
std::vector<std::shared_ptr<UpdateEndpointVM>>& UpdateWebhookTaskVM::getEndpoints()
{
    return m_endpoints;
}

void UpdateWebhookTaskVM::setEndpoints(const std::vector<std::shared_ptr<UpdateEndpointVM>>& value)
{
    m_endpoints = value;
    m_endpointsIsSet = true;
}

bool UpdateWebhookTaskVM::endpointsIsSet() const
{
    return m_endpointsIsSet;
}

void UpdateWebhookTaskVM::unsetendpoints()
{
    m_endpointsIsSet = false;
}
utility::string_t UpdateWebhookTaskVM::getName() const
{
    return m_name;
}

void UpdateWebhookTaskVM::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool UpdateWebhookTaskVM::nameIsSet() const
{
    return m_nameIsSet;
}

void UpdateWebhookTaskVM::unsetname()
{
    m_nameIsSet = false;
}
utility::string_t UpdateWebhookTaskVM::getSubscriptionId() const
{
    return m_subscriptionId;
}

void UpdateWebhookTaskVM::setSubscriptionId(const utility::string_t& value)
{
    m_subscriptionId = value;
    m_subscriptionIdIsSet = true;
}

bool UpdateWebhookTaskVM::subscriptionIdIsSet() const
{
    return m_subscriptionIdIsSet;
}

void UpdateWebhookTaskVM::unsetsubscriptionId()
{
    m_subscriptionIdIsSet = false;
}
std::shared_ptr<TaskType> UpdateWebhookTaskVM::getType() const
{
    return m_type;
}

void UpdateWebhookTaskVM::setType(const std::shared_ptr<TaskType>& value)
{
    m_type = value;
    m_typeIsSet = true;
}

bool UpdateWebhookTaskVM::typeIsSet() const
{
    return m_typeIsSet;
}

void UpdateWebhookTaskVM::unsettype()
{
    m_typeIsSet = false;
}
utility::datetime UpdateWebhookTaskVM::getDelayedRunTime() const
{
    return m_delayedRunTime;
}

void UpdateWebhookTaskVM::setDelayedRunTime(const utility::datetime& value)
{
    m_delayedRunTime = value;
    m_delayedRunTimeIsSet = true;
}

bool UpdateWebhookTaskVM::delayedRunTimeIsSet() const
{
    return m_delayedRunTimeIsSet;
}

void UpdateWebhookTaskVM::unsetdelayedRunTime()
{
    m_delayedRunTimeIsSet = false;
}
utility::string_t UpdateWebhookTaskVM::getCronExpression() const
{
    return m_cronExpression;
}

void UpdateWebhookTaskVM::setCronExpression(const utility::string_t& value)
{
    m_cronExpression = value;
    m_cronExpressionIsSet = true;
}

bool UpdateWebhookTaskVM::cronExpressionIsSet() const
{
    return m_cronExpressionIsSet;
}

void UpdateWebhookTaskVM::unsetcronExpression()
{
    m_cronExpressionIsSet = false;
}
}
