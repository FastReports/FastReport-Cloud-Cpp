...
#include "UpdateThumbnailTemplateTaskVM.h"
...
utility::string_t UpdateThumbnailTemplateTaskVM::getName() const
{
    return m_name;
}

void UpdateThumbnailTemplateTaskVM::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool UpdateThumbnailTemplateTaskVM::nameIsSet() const
{
    return m_nameIsSet;
}

void UpdateThumbnailTemplateTaskVM::unsetname()
{
    m_nameIsSet = false;
}
utility::string_t UpdateThumbnailTemplateTaskVM::getSubscriptionId() const
{
    return m_subscriptionId;
}

void UpdateThumbnailTemplateTaskVM::setSubscriptionId(const utility::string_t& value)
{
    m_subscriptionId = value;
    m_subscriptionIdIsSet = true;
}

bool UpdateThumbnailTemplateTaskVM::subscriptionIdIsSet() const
{
    return m_subscriptionIdIsSet;
}

void UpdateThumbnailTemplateTaskVM::unsetsubscriptionId()
{
    m_subscriptionIdIsSet = false;
}
std::shared_ptr<TaskType> UpdateThumbnailTemplateTaskVM::getType() const
{
    return m_type;
}

void UpdateThumbnailTemplateTaskVM::setType(const std::shared_ptr<TaskType>& value)
{
    m_type = value;
    m_typeIsSet = true;
}

bool UpdateThumbnailTemplateTaskVM::typeIsSet() const
{
    return m_typeIsSet;
}

void UpdateThumbnailTemplateTaskVM::unsettype()
{
    m_typeIsSet = false;
}
utility::datetime UpdateThumbnailTemplateTaskVM::getDelayedRunTime() const
{
    return m_delayedRunTime;
}

void UpdateThumbnailTemplateTaskVM::setDelayedRunTime(const utility::datetime& value)
{
    m_delayedRunTime = value;
    m_delayedRunTimeIsSet = true;
}

bool UpdateThumbnailTemplateTaskVM::delayedRunTimeIsSet() const
{
    return m_delayedRunTimeIsSet;
}

void UpdateThumbnailTemplateTaskVM::unsetdelayedRunTime()
{
    m_delayedRunTimeIsSet = false;
}
utility::string_t UpdateThumbnailTemplateTaskVM::getCronExpression() const
{
    return m_cronExpression;
}

void UpdateThumbnailTemplateTaskVM::setCronExpression(const utility::string_t& value)
{
    m_cronExpression = value;
    m_cronExpressionIsSet = true;
}

bool UpdateThumbnailTemplateTaskVM::cronExpressionIsSet() const
{
    return m_cronExpressionIsSet;
}

void UpdateThumbnailTemplateTaskVM::unsetcronExpression()
{
    m_cronExpressionIsSet = false;
}
}
