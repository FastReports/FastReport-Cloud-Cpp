...
void TransformTaskBaseVM::validate()
{
    // TODO: implement validation
}

web::json::value TransformTaskBaseVM::toJson() const
{
...
bool TransformTaskBaseVM::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t("transports")))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TransportTaskBaseVM>> refVal_transports;
...
void TransformTaskBaseVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TransformTaskBaseVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t TransformTaskBaseVM::getLocale() const
{
    return m_locale;
}

void TransformTaskBaseVM::setLocale(const utility::string_t& value)
{
    m_locale = value;
    m_localeIsSet = true;
}

bool TransformTaskBaseVM::localeIsSet() const
{
    return m_localeIsSet;
}

void TransformTaskBaseVM::unsetlocale()
{
    m_localeIsSet = false;
}
std::shared_ptr<InputFileVM> TransformTaskBaseVM::getInputFile() const
{
    return m_inputFile;
}

void TransformTaskBaseVM::setInputFile(const std::shared_ptr<InputFileVM>& value)
{
    m_inputFile = value;
    m_inputFileIsSet = true;
}

bool TransformTaskBaseVM::inputFileIsSet() const
{
    return m_inputFileIsSet;
}

void TransformTaskBaseVM::unsetinputFile()
{
    m_inputFileIsSet = false;
}
std::shared_ptr<OutputFileVM> TransformTaskBaseVM::getOutputFile() const
{
    return m_outputFile;
}

void TransformTaskBaseVM::setOutputFile(const std::shared_ptr<OutputFileVM>& value)
{
    m_outputFile = value;
    m_outputFileIsSet = true;
}

bool TransformTaskBaseVM::outputFileIsSet() const
{
    return m_outputFileIsSet;
}

void TransformTaskBaseVM::unsetoutputFile()
{
    m_outputFileIsSet = false;
}
std::vector<std::shared_ptr<TransportTaskBaseVM>>& TransformTaskBaseVM::getTransports()
{
    return m_transports;
}

void TransformTaskBaseVM::setTransports(const std::vector<std::shared_ptr<TransportTaskBaseVM>>& value)
{
    m_transports = value;
    m_transportsIsSet = true;
}

bool TransformTaskBaseVM::transportsIsSet() const
{
    return m_transportsIsSet;
}

void TransformTaskBaseVM::unsettransports()
{
    m_transportsIsSet = false;
}
utility::string_t TransformTaskBaseVM::getName() const
{
    return m_name;
}

void TransformTaskBaseVM::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool TransformTaskBaseVM::nameIsSet() const
{
    return m_nameIsSet;
}

void TransformTaskBaseVM::unsetname()
{
    m_nameIsSet = false;
}
utility::string_t TransformTaskBaseVM::getSubscriptionId() const
{
    return m_subscriptionId;
}

void TransformTaskBaseVM::setSubscriptionId(const utility::string_t& value)
{
    m_subscriptionId = value;
    m_subscriptionIdIsSet = true;
}

bool TransformTaskBaseVM::subscriptionIdIsSet() const
{
    return m_subscriptionIdIsSet;
}

void TransformTaskBaseVM::unsetsubscriptionId()
{
    m_subscriptionIdIsSet = false;
}
std::shared_ptr<TaskType> TransformTaskBaseVM::getType() const
{
    return m_type;
}

void TransformTaskBaseVM::setType(const std::shared_ptr<TaskType>& value)
{
    m_type = value;
    m_typeIsSet = true;
}

bool TransformTaskBaseVM::typeIsSet() const
{
    return m_typeIsSet;
}

void TransformTaskBaseVM::unsettype()
{
    m_typeIsSet = false;
}
utility::datetime TransformTaskBaseVM::getDelayedRunTime() const
{
    return m_delayedRunTime;
}

void TransformTaskBaseVM::setDelayedRunTime(const utility::datetime& value)
{
    m_delayedRunTime = value;
    m_delayedRunTimeIsSet = true;
}

bool TransformTaskBaseVM::delayedRunTimeIsSet() const
{
    return m_delayedRunTimeIsSet;
}

void TransformTaskBaseVM::unsetdelayedRunTime()
{
    m_delayedRunTimeIsSet = false;
}
utility::string_t TransformTaskBaseVM::getCronExpression() const
{
    return m_cronExpression;
}

void TransformTaskBaseVM::setCronExpression(const utility::string_t& value)
{
    m_cronExpression = value;
    m_cronExpressionIsSet = true;
}

bool TransformTaskBaseVM::cronExpressionIsSet() const
{
    return m_cronExpressionIsSet;
}

void TransformTaskBaseVM::unsetcronExpression()
{
    m_cronExpressionIsSet = false;
}
}
