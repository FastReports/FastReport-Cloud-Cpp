...
utility::string_t GroupPermissions::getOwnerId() const
{
    return m_ownerId;
}

void GroupPermissions::setOwnerId(const utility::string_t& value)
{
    m_ownerId = value;
    m_ownerIdIsSet = true;
}

bool GroupPermissions::ownerIdIsSet() const
{
    return m_ownerIdIsSet;
}

void GroupPermissions::unsetownerId()
{
    m_ownerIdIsSet = false;
}
std::shared_ptr<GroupPermission> GroupPermissions::getOwner() const
{
    return m_owner;
}

void GroupPermissions::setOwner(const std::shared_ptr<GroupPermission>& value)
{
    m_owner = value;
    m_ownerIsSet = true;
}

bool GroupPermissions::ownerIsSet() const
{
    return m_ownerIsSet;
}

void GroupPermissions::unsetowner()
{
    m_ownerIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<GroupPermission>>& GroupPermissions::getGroups()
{
    return m_groups;
}

void GroupPermissions::setGroups(const std::map<utility::string_t, std::shared_ptr<GroupPermission>>& value)
{
    m_groups = value;
    m_groupsIsSet = true;
}

bool GroupPermissions::groupsIsSet() const
{
    return m_groupsIsSet;
}

void GroupPermissions::unsetgroups()
{
    m_groupsIsSet = false;
}
std::shared_ptr<GroupPermission> GroupPermissions::getOther() const
{
    return m_other;
}

void GroupPermissions::setOther(const std::shared_ptr<GroupPermission>& value)
{
    m_other = value;
    m_otherIsSet = true;
}

bool GroupPermissions::otherIsSet() const
{
    return m_otherIsSet;
}

void GroupPermissions::unsetother()
{
    m_otherIsSet = false;
}
std::shared_ptr<GroupPermission> GroupPermissions::getAnon() const
{
    return m_anon;
}

void GroupPermissions::setAnon(const std::shared_ptr<GroupPermission>& value)
{
    m_anon = value;
    m_anonIsSet = true;
}

bool GroupPermissions::anonIsSet() const
{
    return m_anonIsSet;
}

void GroupPermissions::unsetanon()
{
    m_anonIsSet = false;
}
}
