...
utility::string_t UpdateSubscriptionPlanVM::getReadonlyTimeLimitType() const
{
    return m_readonlyTimeLimitType;
}

void UpdateSubscriptionPlanVM::setReadonlyTimeLimitType(const utility::string_t& value)
{
