...
utility::datetime CreatePrepareTemplateTaskVM::getDelayedRunTime() const
{
    return m_delayedRunTime;
}

void CreatePrepareTemplateTaskVM::setDelayedRunTime(const utility::datetime& value)
{
    m_delayedRunTime = value;
    m_delayedRunTimeIsSet = true;
}

bool CreatePrepareTemplateTaskVM::delayedRunTimeIsSet() const
{
    return m_delayedRunTimeIsSet;
}

void CreatePrepareTemplateTaskVM::unsetdelayedRunTime()
{
    m_delayedRunTimeIsSet = false;
}
utility::string_t CreatePrepareTemplateTaskVM::getCronExpression() const
{
    return m_cronExpression;
}

void CreatePrepareTemplateTaskVM::setCronExpression(const utility::string_t& value)
{
    m_cronExpression = value;
    m_cronExpressionIsSet = true;
}

bool CreatePrepareTemplateTaskVM::cronExpressionIsSet() const
{
    return m_cronExpressionIsSet;
}

void CreatePrepareTemplateTaskVM::unsetcronExpression()
{
    m_cronExpressionIsSet = false;
}
}
