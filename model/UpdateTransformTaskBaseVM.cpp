...
#include "UpdateTransformTaskBaseVM.h"
...
bool UpdateTransformTaskBaseVM::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("transports")))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<UpdateTransportTaskBaseVM>> refVal_transports;
...
std::vector<std::shared_ptr<UpdateTransportTaskBaseVM>>& UpdateTransformTaskBaseVM::getTransports()
{
    return m_transports;
}

void UpdateTransformTaskBaseVM::setTransports(const std::vector<std::shared_ptr<UpdateTransportTaskBaseVM>>& value)
{
    m_transports = value;
    m_transportsIsSet = true;
}

bool UpdateTransformTaskBaseVM::transportsIsSet() const
{
    return m_transportsIsSet;
}

void UpdateTransformTaskBaseVM::unsettransports()
{
    m_transportsIsSet = false;
}
utility::string_t UpdateTransformTaskBaseVM::getName() const
{
    return m_name;
}

void UpdateTransformTaskBaseVM::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool UpdateTransformTaskBaseVM::nameIsSet() const
{
    return m_nameIsSet;
}

void UpdateTransformTaskBaseVM::unsetname()
{
    m_nameIsSet = false;
}
utility::string_t UpdateTransformTaskBaseVM::getSubscriptionId() const
{
    return m_subscriptionId;
}

void UpdateTransformTaskBaseVM::setSubscriptionId(const utility::string_t& value)
{
    m_subscriptionId = value;
    m_subscriptionIdIsSet = true;
}

bool UpdateTransformTaskBaseVM::subscriptionIdIsSet() const
{
    return m_subscriptionIdIsSet;
}

void UpdateTransformTaskBaseVM::unsetsubscriptionId()
{
    m_subscriptionIdIsSet = false;
}
std::shared_ptr<TaskType> UpdateTransformTaskBaseVM::getType() const
{
    return m_type;
}

void UpdateTransformTaskBaseVM::setType(const std::shared_ptr<TaskType>& value)
{
    m_type = value;
    m_typeIsSet = true;
}

bool UpdateTransformTaskBaseVM::typeIsSet() const
{
    return m_typeIsSet;
}

void UpdateTransformTaskBaseVM::unsettype()
{
    m_typeIsSet = false;
}
utility::datetime UpdateTransformTaskBaseVM::getDelayedRunTime() const
{
    return m_delayedRunTime;
}

void UpdateTransformTaskBaseVM::setDelayedRunTime(const utility::datetime& value)
{
    m_delayedRunTime = value;
    m_delayedRunTimeIsSet = true;
}

bool UpdateTransformTaskBaseVM::delayedRunTimeIsSet() const
{
    return m_delayedRunTimeIsSet;
}

void UpdateTransformTaskBaseVM::unsetdelayedRunTime()
{
    m_delayedRunTimeIsSet = false;
}
utility::string_t UpdateTransformTaskBaseVM::getCronExpression() const
{
    return m_cronExpression;
}

void UpdateTransformTaskBaseVM::setCronExpression(const utility::string_t& value)
{
    m_cronExpression = value;
    m_cronExpressionIsSet = true;
}

bool UpdateTransformTaskBaseVM::cronExpressionIsSet() const
{
    return m_cronExpressionIsSet;
}

void UpdateTransformTaskBaseVM::unsetcronExpression()
{
    m_cronExpressionIsSet = false;
}
}
