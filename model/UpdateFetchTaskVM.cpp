...
utility::string_t UpdateFetchTaskVM::getName() const
{
    return m_name;
}

void UpdateFetchTaskVM::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool UpdateFetchTaskVM::nameIsSet() const
{
    return m_nameIsSet;
}

void UpdateFetchTaskVM::unsetname()
{
    m_nameIsSet = false;
}
utility::string_t UpdateFetchTaskVM::getSubscriptionId() const
{
    return m_subscriptionId;
}

void UpdateFetchTaskVM::setSubscriptionId(const utility::string_t& value)
{
    m_subscriptionId = value;
    m_subscriptionIdIsSet = true;
}

bool UpdateFetchTaskVM::subscriptionIdIsSet() const
{
    return m_subscriptionIdIsSet;
}

void UpdateFetchTaskVM::unsetsubscriptionId()
{
    m_subscriptionIdIsSet = false;
}
std::shared_ptr<TaskType> UpdateFetchTaskVM::getType() const
{
    return m_type;
}

void UpdateFetchTaskVM::setType(const std::shared_ptr<TaskType>& value)
{
    m_type = value;
    m_typeIsSet = true;
}

bool UpdateFetchTaskVM::typeIsSet() const
{
    return m_typeIsSet;
}

void UpdateFetchTaskVM::unsettype()
{
    m_typeIsSet = false;
}
utility::datetime UpdateFetchTaskVM::getDelayedRunTime() const
{
    return m_delayedRunTime;
}

void UpdateFetchTaskVM::setDelayedRunTime(const utility::datetime& value)
{
    m_delayedRunTime = value;
    m_delayedRunTimeIsSet = true;
}

bool UpdateFetchTaskVM::delayedRunTimeIsSet() const
{
    return m_delayedRunTimeIsSet;
}

void UpdateFetchTaskVM::unsetdelayedRunTime()
{
    m_delayedRunTimeIsSet = false;
}
utility::string_t UpdateFetchTaskVM::getCronExpression() const
{
    return m_cronExpression;
}

void UpdateFetchTaskVM::setCronExpression(const utility::string_t& value)
{
    m_cronExpression = value;
    m_cronExpressionIsSet = true;
}

bool UpdateFetchTaskVM::cronExpressionIsSet() const
{
    return m_cronExpressionIsSet;
}

void UpdateFetchTaskVM::unsetcronExpression()
{
    m_cronExpressionIsSet = false;
}
}
