...
void TemplatesVM::validate()
{
    // TODO: implement validation
}

web::json::value TemplatesVM::toJson() const
{
...
bool TemplatesVM::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TemplatesVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TemplatesVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::vector<std::shared_ptr<TemplateVM>>& TemplatesVM::getFiles()
{
    return m_files;
}

void TemplatesVM::setFiles(const std::vector<std::shared_ptr<TemplateVM>>& value)
{
    m_files = value;
    m_filesIsSet = true;
}

bool TemplatesVM::filesIsSet() const
{
    return m_filesIsSet;
}

void TemplatesVM::unsetfiles()
{
    m_filesIsSet = false;
}
int64_t TemplatesVM::getCount() const
{
    return m_count;
}

void TemplatesVM::setCount(int64_t value)
{
    m_count = value;
    m_countIsSet = true;
}

bool TemplatesVM::countIsSet() const
{
    return m_countIsSet;
}

void TemplatesVM::unsetcount()
{
    m_countIsSet = false;
}
int32_t TemplatesVM::getSkip() const
{
    return m_skip;
}

void TemplatesVM::setSkip(int32_t value)
{
    m_skip = value;
    m_skipIsSet = true;
}

bool TemplatesVM::skipIsSet() const
{
    return m_skipIsSet;
}

void TemplatesVM::unsetskip()
{
    m_skipIsSet = false;
}
int32_t TemplatesVM::getTake() const
{
    return m_take;
}

void TemplatesVM::setTake(int32_t value)
{
    m_take = value;
    m_takeIsSet = true;
}

bool TemplatesVM::takeIsSet() const
{
    return m_takeIsSet;
}

void TemplatesVM::unsettake()
{
    m_takeIsSet = false;
}
}
