...
utility::datetime FetchTaskVM::getDelayedRunTime() const
{
    return m_delayedRunTime;
}

void FetchTaskVM::setDelayedRunTime(const utility::datetime& value)
{
    m_delayedRunTime = value;
    m_delayedRunTimeIsSet = true;
}

bool FetchTaskVM::delayedRunTimeIsSet() const
{
    return m_delayedRunTimeIsSet;
}

void FetchTaskVM::unsetdelayedRunTime()
{
    m_delayedRunTimeIsSet = false;
}
utility::string_t FetchTaskVM::getCronExpression() const
{
    return m_cronExpression;
}

void FetchTaskVM::setCronExpression(const utility::string_t& value)
{
    m_cronExpression = value;
    m_cronExpressionIsSet = true;
}

bool FetchTaskVM::cronExpressionIsSet() const
{
    return m_cronExpressionIsSet;
}

void FetchTaskVM::unsetcronExpression()
{
    m_cronExpressionIsSet = false;
}
}
