...
bool GroupPermissionsVM::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("permissions")))
    {
        ...
        {
            std::shared_ptr<GroupPermissions> refVal_permissions;
...
std::shared_ptr<GroupPermissions> GroupPermissionsVM::getPermissions() const
{
    return m_permissions;
}

void GroupPermissionsVM::setPermissions(const std::shared_ptr<GroupPermissions>& value)
{
    m_permissions = value;
