...
#include "CreateThumbnailTemplateTaskVM.h"
...
utility::string_t CreateThumbnailTemplateTaskVM::getName() const
{
    return m_name;
}

void CreateThumbnailTemplateTaskVM::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool CreateThumbnailTemplateTaskVM::nameIsSet() const
{
    return m_nameIsSet;
}

void CreateThumbnailTemplateTaskVM::unsetname()
{
    m_nameIsSet = false;
}
utility::string_t CreateThumbnailTemplateTaskVM::getSubscriptionId() const
{
    return m_subscriptionId;
}

void CreateThumbnailTemplateTaskVM::setSubscriptionId(const utility::string_t& value)
{
    m_subscriptionId = value;
    m_subscriptionIdIsSet = true;
}

bool CreateThumbnailTemplateTaskVM::subscriptionIdIsSet() const
{
    return m_subscriptionIdIsSet;
}

void CreateThumbnailTemplateTaskVM::unsetsubscriptionId()
{
    m_subscriptionIdIsSet = false;
}
std::shared_ptr<TaskType> CreateThumbnailTemplateTaskVM::getType() const
{
    return m_type;
}

void CreateThumbnailTemplateTaskVM::setType(const std::shared_ptr<TaskType>& value)
{
    m_type = value;
    m_typeIsSet = true;
}

bool CreateThumbnailTemplateTaskVM::typeIsSet() const
{
    return m_typeIsSet;
}

void CreateThumbnailTemplateTaskVM::unsettype()
{
    m_typeIsSet = false;
}
utility::datetime CreateThumbnailTemplateTaskVM::getDelayedRunTime() const
{
    return m_delayedRunTime;
}

void CreateThumbnailTemplateTaskVM::setDelayedRunTime(const utility::datetime& value)
{
    m_delayedRunTime = value;
    m_delayedRunTimeIsSet = true;
}

bool CreateThumbnailTemplateTaskVM::delayedRunTimeIsSet() const
{
    return m_delayedRunTimeIsSet;
}

void CreateThumbnailTemplateTaskVM::unsetdelayedRunTime()
{
    m_delayedRunTimeIsSet = false;
}
utility::string_t CreateThumbnailTemplateTaskVM::getCronExpression() const
{
    return m_cronExpression;
}

void CreateThumbnailTemplateTaskVM::setCronExpression(const utility::string_t& value)
{
    m_cronExpression = value;
    m_cronExpressionIsSet = true;
}

bool CreateThumbnailTemplateTaskVM::cronExpressionIsSet() const
{
    return m_cronExpressionIsSet;
}

void CreateThumbnailTemplateTaskVM::unsetcronExpression()
{
    m_cronExpressionIsSet = false;
}
}
