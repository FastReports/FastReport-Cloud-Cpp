...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<UpdateExportReportTaskVM>>& getExports();
    bool exportsIsSet() const;
    void unsetexports();

    void setExports(const std::vector<std::shared_ptr<UpdateExportReportTaskVM>>& value);
...
protected:
    std::vector<std::shared_ptr<UpdateExportReportTaskVM>> m_exports;
    bool m_exportsIsSet;
