...
SubscriptionUsersVM::SubscriptionUsersVM()
{
    m_usersIsSet = false;
    m_count = 0L;
    m_countIsSet = false;
...
void SubscriptionUsersVM::validate()
{
    // TODO: implement validation
}

web::json::value SubscriptionUsersVM::toJson() const
{
...
bool SubscriptionUsersVM::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t("users")))
    {
        ...
        {
            std::vector<std::shared_ptr<SubscriptionUserVM>> refVal_users;
...
void SubscriptionUsersVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SubscriptionUsersVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::vector<std::shared_ptr<SubscriptionUserVM>>& SubscriptionUsersVM::getUsers()
{
    return m_users;
}

void SubscriptionUsersVM::setUsers(const std::vector<std::shared_ptr<SubscriptionUserVM>>& value)
{
    m_users = value;
    m_usersIsSet = true;
}

bool SubscriptionUsersVM::usersIsSet() const
{
    return m_usersIsSet;
}

void SubscriptionUsersVM::unsetusers()
{
    m_usersIsSet = false;
}
int64_t SubscriptionUsersVM::getCount() const
{
    return m_count;
}

void SubscriptionUsersVM::setCount(int64_t value)
{
    m_count = value;
    m_countIsSet = true;
}

bool SubscriptionUsersVM::countIsSet() const
{
    return m_countIsSet;
}

void SubscriptionUsersVM::unsetcount()
{
    m_countIsSet = false;
}
int32_t SubscriptionUsersVM::getTake() const
{
    return m_take;
}

void SubscriptionUsersVM::setTake(int32_t value)
{
    m_take = value;
    m_takeIsSet = true;
}

bool SubscriptionUsersVM::takeIsSet() const
{
    return m_takeIsSet;
}

void SubscriptionUsersVM::unsettake()
{
    m_takeIsSet = false;
}
int32_t SubscriptionUsersVM::getSkip() const
{
    return m_skip;
}

void SubscriptionUsersVM::setSkip(int32_t value)
{
    m_skip = value;
    m_skipIsSet = true;
}

bool SubscriptionUsersVM::skipIsSet() const
{
    return m_skipIsSet;
}

void SubscriptionUsersVM::unsetskip()
{
    m_skipIsSet = false;
}
}
