...
/*
 * CreateWebhookTaskVM.h
 *
 * 
 */

#ifndef FASTREPORT_CLOUD_MODELS_CreateWebhookTaskVM_H_
#define FASTREPORT_CLOUD_MODELS_CreateWebhookTaskVM_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// CreateWebhookTaskVM members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CreateEndpointVM>>& getEndpoints();
    bool endpointsIsSet() const;
    void unsetendpoints();

    void setEndpoints(const std::vector<std::shared_ptr<CreateEndpointVM>>& value);
...
protected:
    std::vector<std::shared_ptr<CreateEndpointVM>> m_endpoints;
...
#endif /* FASTREPORT_CLOUD_MODELS_CreateWebhookTaskVM_H_ */
