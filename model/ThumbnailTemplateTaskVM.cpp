...
#include "ThumbnailTemplateTaskVM.h"
...
utility::string_t ThumbnailTemplateTaskVM::getName() const
{
    return m_name;
}

void ThumbnailTemplateTaskVM::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool ThumbnailTemplateTaskVM::nameIsSet() const
{
    return m_nameIsSet;
}

void ThumbnailTemplateTaskVM::unsetname()
{
    m_nameIsSet = false;
}
utility::string_t ThumbnailTemplateTaskVM::getSubscriptionId() const
{
    return m_subscriptionId;
}

void ThumbnailTemplateTaskVM::setSubscriptionId(const utility::string_t& value)
{
    m_subscriptionId = value;
    m_subscriptionIdIsSet = true;
}

bool ThumbnailTemplateTaskVM::subscriptionIdIsSet() const
{
    return m_subscriptionIdIsSet;
}

void ThumbnailTemplateTaskVM::unsetsubscriptionId()
{
    m_subscriptionIdIsSet = false;
}
std::shared_ptr<TaskType> ThumbnailTemplateTaskVM::getType() const
{
    return m_type;
}

void ThumbnailTemplateTaskVM::setType(const std::shared_ptr<TaskType>& value)
{
    m_type = value;
    m_typeIsSet = true;
}

bool ThumbnailTemplateTaskVM::typeIsSet() const
{
    return m_typeIsSet;
}

void ThumbnailTemplateTaskVM::unsettype()
{
    m_typeIsSet = false;
}
utility::datetime ThumbnailTemplateTaskVM::getDelayedRunTime() const
{
    return m_delayedRunTime;
}

void ThumbnailTemplateTaskVM::setDelayedRunTime(const utility::datetime& value)
{
    m_delayedRunTime = value;
    m_delayedRunTimeIsSet = true;
}

bool ThumbnailTemplateTaskVM::delayedRunTimeIsSet() const
{
    return m_delayedRunTimeIsSet;
}

void ThumbnailTemplateTaskVM::unsetdelayedRunTime()
{
    m_delayedRunTimeIsSet = false;
}
utility::string_t ThumbnailTemplateTaskVM::getCronExpression() const
{
    return m_cronExpression;
}

void ThumbnailTemplateTaskVM::setCronExpression(const utility::string_t& value)
{
    m_cronExpression = value;
    m_cronExpressionIsSet = true;
}

bool ThumbnailTemplateTaskVM::cronExpressionIsSet() const
{
    return m_cronExpressionIsSet;
}

void ThumbnailTemplateTaskVM::unsetcronExpression()
{
    m_cronExpressionIsSet = false;
}
}
