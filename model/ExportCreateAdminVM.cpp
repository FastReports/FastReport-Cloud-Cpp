...
void ExportCreateAdminVM::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool ExportCreateAdminVM::nameIsSet() const
{
    return m_nameIsSet;
}

void ExportCreateAdminVM::unsetname()
{
    m_nameIsSet = false;
}
std::vector<utility::string_t>& ExportCreateAdminVM::getTags()
{
    return m_tags;
}

void ExportCreateAdminVM::setTags(const std::vector<utility::string_t>& value)
{
    m_tags = value;
    m_tagsIsSet = true;
}

bool ExportCreateAdminVM::tagsIsSet() const
{
    return m_tagsIsSet;
}

void ExportCreateAdminVM::unsettags()
{
    m_tagsIsSet = false;
}
utility::string_t ExportCreateAdminVM::getIcon() const
{
    return m_icon;
}

void ExportCreateAdminVM::setIcon(const utility::string_t& value)
{
    m_icon = value;
    m_iconIsSet = true;
}

bool ExportCreateAdminVM::iconIsSet() const
{
    return m_iconIsSet;
}

void ExportCreateAdminVM::unseticon()
{
    m_iconIsSet = false;
}
utility::string_t ExportCreateAdminVM::getContent() const
{
    return m_content;
}

void ExportCreateAdminVM::setContent(const utility::string_t& value)
{
    m_content = value;
    m_contentIsSet = true;
}

bool ExportCreateAdminVM::contentIsSet() const
{
    return m_contentIsSet;
}

void ExportCreateAdminVM::unsetcontent()
{
    m_contentIsSet = false;
}
}
