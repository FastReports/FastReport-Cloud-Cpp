...
void AdminFolderCreateVM::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool AdminFolderCreateVM::nameIsSet() const
{
    return m_nameIsSet;
}

void AdminFolderCreateVM::unsetname()
{
    m_nameIsSet = false;
}
std::vector<utility::string_t>& AdminFolderCreateVM::getTags()
{
    return m_tags;
}

void AdminFolderCreateVM::setTags(const std::vector<utility::string_t>& value)
{
    m_tags = value;
    m_tagsIsSet = true;
}

bool AdminFolderCreateVM::tagsIsSet() const
{
    return m_tagsIsSet;
}

void AdminFolderCreateVM::unsettags()
{
    m_tagsIsSet = false;
}
utility::string_t AdminFolderCreateVM::getIcon() const
{
    return m_icon;
}

void AdminFolderCreateVM::setIcon(const utility::string_t& value)
{
    m_icon = value;
    m_iconIsSet = true;
}

bool AdminFolderCreateVM::iconIsSet() const
{
    return m_iconIsSet;
}

void AdminFolderCreateVM::unseticon()
{
    m_iconIsSet = false;
}
}
