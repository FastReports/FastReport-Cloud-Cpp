...
int32_t AdminPermission::getCreate() const
{
    return m_create;
}

void AdminPermission::setCreate(int32_t value)
{
    m_create = value;
    m_createIsSet = true;
}
...
int32_t AdminPermission::getRDelete() const
{
    return m_r_delete;
}

void AdminPermission::setRDelete(int32_t value)
{
    m_r_delete = value;
...
int32_t AdminPermission::getExecute() const
{
    return m_execute;
}

void AdminPermission::setExecute(int32_t value)
{
    m_execute = value;
    m_executeIsSet = true;
}
...
int32_t AdminPermission::getGet() const
{
    return m_get;
}

void AdminPermission::setGet(int32_t value)
{
    m_get = value;
    m_getIsSet = true;
}
...
int32_t AdminPermission::getUpdate() const
{
    return m_update;
}

void AdminPermission::setUpdate(int32_t value)
{
    m_update = value;
    m_updateIsSet = true;
}
...
int32_t AdminPermission::getAdministrate() const
{
    return m_administrate;
}

void AdminPermission::setAdministrate(int32_t value)
{
