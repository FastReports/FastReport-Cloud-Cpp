...
utility::string_t ReportCreateAdminVM::getTemplateId() const
{
    return m_templateId;
}

void ReportCreateAdminVM::setTemplateId(const utility::string_t& value)
{
    m_templateId = value;
    m_templateIdIsSet = true;
}

bool ReportCreateAdminVM::templateIdIsSet() const
{
    return m_templateIdIsSet;
}

void ReportCreateAdminVM::unsettemplateId()
{
    m_templateIdIsSet = false;
}
utility::string_t ReportCreateAdminVM::getName() const
{
    return m_name;
}

void ReportCreateAdminVM::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool ReportCreateAdminVM::nameIsSet() const
{
    return m_nameIsSet;
}

void ReportCreateAdminVM::unsetname()
{
    m_nameIsSet = false;
}
std::vector<utility::string_t>& ReportCreateAdminVM::getTags()
{
    return m_tags;
}

void ReportCreateAdminVM::setTags(const std::vector<utility::string_t>& value)
{
    m_tags = value;
    m_tagsIsSet = true;
}

bool ReportCreateAdminVM::tagsIsSet() const
{
    return m_tagsIsSet;
}

void ReportCreateAdminVM::unsettags()
{
    m_tagsIsSet = false;
}
utility::string_t ReportCreateAdminVM::getIcon() const
{
    return m_icon;
}

void ReportCreateAdminVM::setIcon(const utility::string_t& value)
{
    m_icon = value;
    m_iconIsSet = true;
}

bool ReportCreateAdminVM::iconIsSet() const
{
    return m_iconIsSet;
}

void ReportCreateAdminVM::unseticon()
{
    m_iconIsSet = false;
}
utility::string_t ReportCreateAdminVM::getContent() const
{
    return m_content;
}

void ReportCreateAdminVM::setContent(const utility::string_t& value)
{
    m_content = value;
    m_contentIsSet = true;
}

bool ReportCreateAdminVM::contentIsSet() const
{
    return m_contentIsSet;
}

void ReportCreateAdminVM::unsetcontent()
{
    m_contentIsSet = false;
}
}
