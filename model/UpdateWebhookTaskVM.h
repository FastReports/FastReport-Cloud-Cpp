...
/*
 * UpdateWebhookTaskVM.h
 *
 * 
 */

#ifndef FASTREPORT_CLOUD_MODELS_UpdateWebhookTaskVM_H_
#define FASTREPORT_CLOUD_MODELS_UpdateWebhookTaskVM_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// UpdateWebhookTaskVM members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<UpdateEndpointVM>>& getEndpoints();
    bool endpointsIsSet() const;
    void unsetendpoints();

    void setEndpoints(const std::vector<std::shared_ptr<UpdateEndpointVM>>& value);
...
protected:
    std::vector<std::shared_ptr<UpdateEndpointVM>> m_endpoints;
...
#endif /* FASTREPORT_CLOUD_MODELS_UpdateWebhookTaskVM_H_ */
