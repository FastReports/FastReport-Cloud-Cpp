...
utility::string_t UpdateTaskBaseVM::getSubscriptionId() const
{
    return m_subscriptionId;
}

void UpdateTaskBaseVM::setSubscriptionId(const utility::string_t& value)
{
    m_subscriptionId = value;
    m_subscriptionIdIsSet = true;
}

bool UpdateTaskBaseVM::subscriptionIdIsSet() const
{
    return m_subscriptionIdIsSet;
}

void UpdateTaskBaseVM::unsetsubscriptionId()
{
    m_subscriptionIdIsSet = false;
}
std::shared_ptr<TaskType> UpdateTaskBaseVM::getType() const
{
    return m_type;
}

void UpdateTaskBaseVM::setType(const std::shared_ptr<TaskType>& value)
{
    m_type = value;
    m_typeIsSet = true;
}

bool UpdateTaskBaseVM::typeIsSet() const
{
    return m_typeIsSet;
}

void UpdateTaskBaseVM::unsettype()
{
    m_typeIsSet = false;
}
