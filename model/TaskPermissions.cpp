...
void TaskPermissions::validate()
{
    // TODO: implement validation
}

web::json::value TaskPermissions::toJson() const
{
...
bool TaskPermissions::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TaskPermissions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TaskPermissions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t TaskPermissions::getOwnerId() const
{
    return m_ownerId;
}

void TaskPermissions::setOwnerId(const utility::string_t& value)
{
    m_ownerId = value;
    m_ownerIdIsSet = true;
}

bool TaskPermissions::ownerIdIsSet() const
{
    return m_ownerIdIsSet;
}

void TaskPermissions::unsetownerId()
{
    m_ownerIdIsSet = false;
}
std::shared_ptr<TaskPermission> TaskPermissions::getOwner() const
{
    return m_owner;
}

void TaskPermissions::setOwner(const std::shared_ptr<TaskPermission>& value)
{
    m_owner = value;
    m_ownerIsSet = true;
}

bool TaskPermissions::ownerIsSet() const
{
    return m_ownerIsSet;
}

void TaskPermissions::unsetowner()
{
    m_ownerIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<TaskPermission>>& TaskPermissions::getGroups()
{
    return m_groups;
}

void TaskPermissions::setGroups(const std::map<utility::string_t, std::shared_ptr<TaskPermission>>& value)
{
    m_groups = value;
    m_groupsIsSet = true;
}

bool TaskPermissions::groupsIsSet() const
{
    return m_groupsIsSet;
}

void TaskPermissions::unsetgroups()
{
    m_groupsIsSet = false;
}
std::shared_ptr<TaskPermission> TaskPermissions::getOther() const
{
    return m_other;
}

void TaskPermissions::setOther(const std::shared_ptr<TaskPermission>& value)
{
    m_other = value;
    m_otherIsSet = true;
}

bool TaskPermissions::otherIsSet() const
{
    return m_otherIsSet;
}

void TaskPermissions::unsetother()
{
    m_otherIsSet = false;
}
std::shared_ptr<TaskPermission> TaskPermissions::getAnon() const
{
    return m_anon;
}

void TaskPermissions::setAnon(const std::shared_ptr<TaskPermission>& value)
{
    m_anon = value;
    m_anonIsSet = true;
}

bool TaskPermissions::anonIsSet() const
{
    return m_anonIsSet;
}

void TaskPermissions::unsetanon()
{
    m_anonIsSet = false;
}
}
