...
UpdateEndpointVM::UpdateEndpointVM()
{
...
void UpdateEndpointVM::validate()
{
    // TODO: implement validation
}

web::json::value UpdateEndpointVM::toJson() const
{
...
bool UpdateEndpointVM::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateEndpointVM::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateEndpointVM::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t UpdateEndpointVM::getBearerToken() const
{
    return m_bearerToken;
}

void UpdateEndpointVM::setBearerToken(const utility::string_t& value)
{
    m_bearerToken = value;
    m_bearerTokenIsSet = true;
}

bool UpdateEndpointVM::bearerTokenIsSet() const
{
    return m_bearerTokenIsSet;
}

void UpdateEndpointVM::unsetbearerToken()
{
    m_bearerTokenIsSet = false;
}
std::map<utility::string_t, utility::string_t>& UpdateEndpointVM::getHeaders()
{
    return m_headers;
}

void UpdateEndpointVM::setHeaders(const std::map<utility::string_t, utility::string_t>& value)
{
    m_headers = value;
    m_headersIsSet = true;
}

bool UpdateEndpointVM::headersIsSet() const
{
    return m_headersIsSet;
}

void UpdateEndpointVM::unsetheaders()
{
    m_headersIsSet = false;
}
utility::string_t UpdateEndpointVM::getUrl() const
{
    return m_url;
}

void UpdateEndpointVM::setUrl(const utility::string_t& value)
{
    m_url = value;
    m_urlIsSet = true;
}

bool UpdateEndpointVM::urlIsSet() const
{
    return m_urlIsSet;
}

void UpdateEndpointVM::unseturl()
{
    m_urlIsSet = false;
}
}
