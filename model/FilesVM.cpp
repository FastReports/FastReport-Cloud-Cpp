...
std::vector<std::shared_ptr<FileVM>>& FilesVM::getFiles()
{
    return m_files;
}

void FilesVM::setFiles(const std::vector<std::shared_ptr<FileVM>>& value)
{
    m_files = value;
    m_filesIsSet = true;
}

bool FilesVM::filesIsSet() const
{
    return m_filesIsSet;
}

void FilesVM::unsetfiles()
{
    m_filesIsSet = false;
}
int64_t FilesVM::getCount() const
{
    return m_count;
}

void FilesVM::setCount(int64_t value)
{
    m_count = value;
    m_countIsSet = true;
}

bool FilesVM::countIsSet() const
{
    return m_countIsSet;
}

void FilesVM::unsetcount()
{
    m_countIsSet = false;
}
int32_t FilesVM::getSkip() const
{
    return m_skip;
}

void FilesVM::setSkip(int32_t value)
{
    m_skip = value;
    m_skipIsSet = true;
}

bool FilesVM::skipIsSet() const
{
    return m_skipIsSet;
}

void FilesVM::unsetskip()
{
    m_skipIsSet = false;
}
int32_t FilesVM::getTake() const
{
    return m_take;
}

void FilesVM::setTake(int32_t value)
{
    m_take = value;
    m_takeIsSet = true;
}

bool FilesVM::takeIsSet() const
{
    return m_takeIsSet;
}

void FilesVM::unsettake()
{
    m_takeIsSet = false;
}
}
