...
void DataSourcePermissions::validate()
{
    // TODO: implement validation
}

web::json::value DataSourcePermissions::toJson() const
{
...
bool DataSourcePermissions::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t("owner")))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<DataSourcePermission> refVal_owner;
    ...
    if(val.has_field(utility::conversions::to_string_t("groups")))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::map<utility::string_t, std::shared_ptr<DataSourcePermission>> refVal_groups;
    ...
    if(val.has_field(utility::conversions::to_string_t("other")))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<DataSourcePermission> refVal_other;
    ...
    if(val.has_field(utility::conversions::to_string_t("anon")))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<DataSourcePermission> refVal_anon;
...
void DataSourcePermissions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DataSourcePermissions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t DataSourcePermissions::getOwnerId() const
{
    return m_ownerId;
}

void DataSourcePermissions::setOwnerId(const utility::string_t& value)
{
    m_ownerId = value;
    m_ownerIdIsSet = true;
}

bool DataSourcePermissions::ownerIdIsSet() const
{
    return m_ownerIdIsSet;
}

void DataSourcePermissions::unsetownerId()
{
    m_ownerIdIsSet = false;
}
std::shared_ptr<DataSourcePermission> DataSourcePermissions::getOwner() const
{
    return m_owner;
}

void DataSourcePermissions::setOwner(const std::shared_ptr<DataSourcePermission>& value)
{
    m_owner = value;
    m_ownerIsSet = true;
}

bool DataSourcePermissions::ownerIsSet() const
{
    return m_ownerIsSet;
}

void DataSourcePermissions::unsetowner()
{
    m_ownerIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<DataSourcePermission>>& DataSourcePermissions::getGroups()
{
    return m_groups;
}

void DataSourcePermissions::setGroups(const std::map<utility::string_t, std::shared_ptr<DataSourcePermission>>& value)
{
    m_groups = value;
    m_groupsIsSet = true;
}

bool DataSourcePermissions::groupsIsSet() const
{
    return m_groupsIsSet;
}

void DataSourcePermissions::unsetgroups()
{
    m_groupsIsSet = false;
}
std::shared_ptr<DataSourcePermission> DataSourcePermissions::getOther() const
{
    return m_other;
}

void DataSourcePermissions::setOther(const std::shared_ptr<DataSourcePermission>& value)
{
    m_other = value;
    m_otherIsSet = true;
}

bool DataSourcePermissions::otherIsSet() const
{
    return m_otherIsSet;
}

void DataSourcePermissions::unsetother()
{
    m_otherIsSet = false;
}
std::shared_ptr<DataSourcePermission> DataSourcePermissions::getAnon() const
{
    return m_anon;
}

void DataSourcePermissions::setAnon(const std::shared_ptr<DataSourcePermission>& value)
{
    m_anon = value;
    m_anonIsSet = true;
}

bool DataSourcePermissions::anonIsSet() const
{
    return m_anonIsSet;
}

void DataSourcePermissions::unsetanon()
{
    m_anonIsSet = false;
}
}
