...
utility::datetime EmailTaskVM::getDelayedRunTime() const
{
    return m_delayedRunTime;
}

void EmailTaskVM::setDelayedRunTime(const utility::datetime& value)
{
    m_delayedRunTime = value;
    m_delayedRunTimeIsSet = true;
}

bool EmailTaskVM::delayedRunTimeIsSet() const
{
    return m_delayedRunTimeIsSet;
}

void EmailTaskVM::unsetdelayedRunTime()
{
    m_delayedRunTimeIsSet = false;
}
utility::string_t EmailTaskVM::getCronExpression() const
{
    return m_cronExpression;
}

void EmailTaskVM::setCronExpression(const utility::string_t& value)
{
    m_cronExpression = value;
    m_cronExpressionIsSet = true;
}

bool EmailTaskVM::cronExpressionIsSet() const
{
    return m_cronExpressionIsSet;
}

void EmailTaskVM::unsetcronExpression()
{
    m_cronExpressionIsSet = false;
}
}
