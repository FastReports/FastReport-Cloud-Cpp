...
utility::datetime CreateFetchTaskVM::getDelayedRunTime() const
{
    return m_delayedRunTime;
}

void CreateFetchTaskVM::setDelayedRunTime(const utility::datetime& value)
{
    m_delayedRunTime = value;
    m_delayedRunTimeIsSet = true;
}

bool CreateFetchTaskVM::delayedRunTimeIsSet() const
{
    return m_delayedRunTimeIsSet;
}

void CreateFetchTaskVM::unsetdelayedRunTime()
{
    m_delayedRunTimeIsSet = false;
}
utility::string_t CreateFetchTaskVM::getCronExpression() const
{
    return m_cronExpression;
}

void CreateFetchTaskVM::setCronExpression(const utility::string_t& value)
{
    m_cronExpression = value;
    m_cronExpressionIsSet = true;
}

bool CreateFetchTaskVM::cronExpressionIsSet() const
{
    return m_cronExpressionIsSet;
}

void CreateFetchTaskVM::unsetcronExpression()
{
    m_cronExpressionIsSet = false;
}
}
