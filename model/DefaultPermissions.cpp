...
void DefaultPermissions::validate()
{
    // TODO: implement validation
}

web::json::value DefaultPermissions::toJson() const
{
...
bool DefaultPermissions::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DefaultPermissions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DefaultPermissions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<FilePermissions> DefaultPermissions::getFilePermissions() const
{
    return m_filePermissions;
}

void DefaultPermissions::setFilePermissions(const std::shared_ptr<FilePermissions>& value)
{
    m_filePermissions = value;
    m_filePermissionsIsSet = true;
}

bool DefaultPermissions::filePermissionsIsSet() const
{
    return m_filePermissionsIsSet;
}

void DefaultPermissions::unsetfilePermissions()
{
    m_filePermissionsIsSet = false;
}
std::shared_ptr<GroupPermissions> DefaultPermissions::getGroupPermissions() const
{
    return m_groupPermissions;
}

void DefaultPermissions::setGroupPermissions(const std::shared_ptr<GroupPermissions>& value)
{
    m_groupPermissions = value;
    m_groupPermissionsIsSet = true;
}

bool DefaultPermissions::groupPermissionsIsSet() const
{
    return m_groupPermissionsIsSet;
}

void DefaultPermissions::unsetgroupPermissions()
{
    m_groupPermissionsIsSet = false;
}
std::shared_ptr<DataSourcePermissions> DefaultPermissions::getDataSourcePermissions() const
{
    return m_dataSourcePermissions;
}

void DefaultPermissions::setDataSourcePermissions(const std::shared_ptr<DataSourcePermissions>& value)
{
    m_dataSourcePermissions = value;
    m_dataSourcePermissionsIsSet = true;
}

bool DefaultPermissions::dataSourcePermissionsIsSet() const
{
    return m_dataSourcePermissionsIsSet;
}

void DefaultPermissions::unsetdataSourcePermissions()
{
    m_dataSourcePermissionsIsSet = false;
}
}
